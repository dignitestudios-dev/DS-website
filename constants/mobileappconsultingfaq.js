export const MOBILE_APP_CONSULTING_FAQS = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "We have our expertise in each sector whether health apps, e-commerce, traveling, insurance, and so on. Here, we value our customers from multiple platforms and encourage their ideas to form a visionary project. Our service does not only hold a mobile app consulting for a particular size of the market, but we also deliver end-to-end solutions to our clients globally and broadly.",
      },
    },
    {
      "@type": "Question",

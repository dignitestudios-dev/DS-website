...
export const chooseus = [
  {
    icon: "/quick-response.webp",
    title: "Mobile App Development Quick Response",
    alt:"mobile app development quick response icon",
    description:
  ...
  {
    icon: "/fast-delivery.webp",
    title: "Mobile App Development Fast Delivery",
    alt:"mobile app development fast delivery icon",
    description:
  ...
  },
  {
    ...
    title: "Mobile App Development Satisfaction Guaranteed",
    alt:"mobile app development satisfaction guaranteed icon",
    description:
  ...
  {
    icon: "/quality-work.webp",
    title: "Mobile App Development High-Quality Work",
    alt:"mobile app development high quality work icon",
    description:
  ...
  {
    icon: "/unlimited-revisions.webp",
    title: "Mobile App Development Unlimited Revisions",
    alt:"mobile app development unlimited revisions icon",
    description:
  ...
  {
    icon: "/cost-effective.webp",
    title: "Mobile App Development Cost Effective",
    alt:"mobile app development cost effective icon",
    description:

export const PROGRESSIVE_WEB_APP_SERVICES = [
  {
    image_src: "/progressive-web-app-development-services-icon.png",
  ...
  {
    image_src: "/application-shell-architecture.png",
  ...
  {
    image_src: "/progressive-pwa-migration-icon.png",
    title: "PWA Migration",
  ...
  {
    image_src: "/progressive-responsive-web-app-design-icon.png",

...
export const paragraphs = {
  ...
  "Mobile Application Testing": {
    description:
      "Testing your mobile application can be the hardest phase that can reflect your performance anytime. And if you ignore rigorous testing it can damage your credibility and worthiness. So, to ensure its quality, functionality, performance, usability, compatibility, and security, your app developer of <a href='/services/mobile-app-testing-services' class='text-[#F15C20]'>mobile application testing services</a> must ensure the removal of bugs and security issues to adhere to its worthiness. And, so Dignite Studios will make your <a href='/services/mobile-app-testing-services' class='text-[#F15C20]'>mobile application testing services</a> beyond any doubt with high-performing tools and methods to test your application such as emulators, simulators, devices, and beta testing. Therefore, you can test your application user interface on your mobile device to ensure its functionality.",
    image: "/top-mobile-app-development-testing-services.png",
    image_title:"top mobile app development testing services",
    image_alt:"image shows man is holding a mobile device that appears top mobile app testing screen",
    page_url:"/services/mobile-app-testing-services"
  },
  "IOS App Development": {
    description:
      "Well, android indeed has the largest market share globally, but IOS users are willing to pay more for the apps via the Apple App Store. With those concerns, our highly skillful mobile app development body uses integrated Apple Xcode to test, build, and package apps. Whereas, <a href='/services/ios-app-development' class='text-[#F15C20]'>IOS app development services</a> can play a vital role in forming an effective IOS application.",
    image: "/home-ios-development.png",
    image_title:"",
    image_alt:"",
    page_url:"/services/ios-app-development"
  },
  "Android App Development": {
    description:
  ...
  "Web Application Development": {
    description:
      "Are you worried about your <a href='/services/web-app-development' class='text-[#F15C20]'>web application development services</a>? No need to, our valuable and reliable web application team can help you to create the application process on remote servers and also on any medium of the user’s device.",
    image: "/home-web-app-development.png",
    image_title:"",
    image_alt:"",
    page_url:"/services/web-app-development"
  },
};
...
export const items = [
  ...
  },
  {
    ...
    text: "Testing your mobile application can be the hardest phase that can reflect your performance anytime. And if you ignore rigorous testing it can damage your credibility and worthiness. So, to ensure its quality, functionality, performance, usability, compatibility, and security, your app developer of <a href='/services/mobile-app-testing-services' class='text-[#F15C20]'>mobile application testing services</a> must ensure the removal of bugs and security issues to adhere to its worthiness. And, so Dignite Studios will make your <a href='/services/mobile-app-testing-services' class='text-[#F15C20]'>mobile application testing services</a> beyond any doubt with high-performing tools and methods to test your application such as emulators, simulators, devices, and beta testing. Therefore, you can test your application user interface on your mobile device to ensure its functionality.",
  },
  {
    heading: "IOS App Development",
    text: "Well, android indeed has the largest market share globally, but IOS users are willing to pay more for the apps via the Apple App Store. With those concerns, our highly skillful mobile app development body uses integrated Apple Xcode to test, build, and package apps. Whereas, <a href='/services/ios-app-development' class='text-[#F15C20]'>IOS app development services</a> can play a vital role in forming an effective IOS application.",
  },
  {
  ...
  },
  {
    ...
    text: "Are you worried about your <a href='/services/web-app-development' class='text-[#F15C20]'>web application development services</a>? No need to, our valuable and reliable web application team can help you to create the application process on remote servers and also on any medium of the user’s device.",
  },
];

  ...
  return (
    ...
    >
      ...
      <Link
        ...
        className="w-[120px] lg:w-[160px] h-12 lg:h-16 rounded-full transition-all duration-150 hover:opacity-90 bg-[#F15C20] shadow-xl text-white text-md font-medium shadow-[#F15C20]/[0.3] flex items-center justify-center gap-4"
      >
        Get Started
      </Link>
    </div>

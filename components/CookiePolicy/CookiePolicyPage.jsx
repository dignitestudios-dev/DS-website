...
const CookiePolicyPage = () => {
  ...
  return (
    <div
      className="w-full h-auto flex flex-col gap-4 justify-start items-start px-4 md:px-12 lg:px-28"
      style={{
    ...
    >
      ...
      <div>
        ...
        <p>
          <span>
            By accessing and placing an order with Carter Boating, you confirm
            ...
            apply to the entire mobile application and any email or other type
            of communication between you and Carter Boating.
          </span>
        </p>
        <p>
          <br />
        ...
        <p>
          <span>
            Under no circumstances shall Carter Boating team be liable for any
            ...
            even if Carter Boating team or an authorized representative has been
        ...
        <p>
          <span>
            Carter Boating will not be responsible for any outcome that may
        ...
        <p>
          <span>
            Carter Boating grants you a revocable, non-exclusive,
        ...
        <p>
          <span>
            These Terms &amp; Conditions are a contract between you and Carter
            Boating (referred to in these Terms &amp; Conditions as &quot;Carter
            Boating&quot;, &quot;us&quot;, &quot;we&quot; or &quot;our&quot;),
            the provider of the Carter Boating mobile application and the
            services accessible from the Carter Boating mobile application
            (which are collectively referred to in these Terms &amp; Conditions
            as the &quot;Carter Boating Service&quot;).
          </span>
        </p>
        <p>
          <br />
        ...
        <p>
          <span>
            ...
            Carter Boating Service. In these Terms &amp; Conditions,
        ...
        <p>
          <span>
            Cookie: small amount of data generated by a mobile application and
        ...
        <p>
          <span>
            Company: when this terms mention &ldquo;Company,&rdquo;
            &ldquo;we,&rdquo; &ldquo;us,&rdquo; or &ldquo;our,&rdquo; it refers
            to Carter Fishing, (1660-1 Norman Park Dr, Tallahassee, FL, 32304),
        ...
        <p>
          <span>
            Country: where Carter Boating or the owners/founders of Carter
            Boating are based, in this case is United States
          </span>
        </p>
        <p>
          <span>
            Device: any internet connected device such as a phone, tablet,
            computer or any other device that can be used to visit Carter
            Boating and use the services.
          </span>
        </p>
        <p>
          <span>
            Service: refers to the service provided by Carter Boating as
        ...
        <p>
          <span>
            App/Application: Carter Boating app, refers to the SOFTWARE PRODUCT
            identified above.
          </span>
        </p>
        <p>
          <span>
            You: a person or entity that is registered with Carter Boating to
            use the Services.
          </span>
        </p>
        <p>
        ...
        <p>
          <span>You agree not to, and you will not permit others to:</span>
        </p>
        <p>
          <br />
        </p>
        ...
        <p>
          <span>
            ...
            notice of copyright or trademark) of Carter Boating or its
        ...
        <p>
          <span>
            ...
            indicated in an order form, you must provide Carter Boating with a
            valid credit card (Visa, MasterCard, or any other issuer accepted by
            us) (&ldquo;Payment Provider&rdquo;) as a condition to signing up
            for the Premium plan. Your Payment Provider agreement governs your
            use of the designated credit card account, and you must refer to
            ...
            Carter Boating with your credit card number and associated payment
            information, you agree that Carter Boating is authorized to verify
            information immediately, and subsequently invoice your account for
            all fees and charges due and payable to Carter Boating hereunder and
            that no additional notice or consent is required. You agree to
            immediately notify Carter Boating of any change in your billing
            address or the credit card used for payment hereunder. Carter
            Boating reserves the right at any time to change its prices and
            billing methods, either immediately upon posting on our Site or by
            e-mail delivery to your organization&rsquo;s administrator(s).
          </span>
        </p>
        <p>
          <br />
        ...
        <p>
          <span>
            No contract will exist between you and Carter Boating for the
            Service until Carter Boating accepts your order by a confirmatory
            e-mail, SMS/MMS message, or other appropriate means of
            communication.
          </span>
        </p>
        <p>
        ...
        <p>
          <span>
            Thanks for shopping at Carter Boating. We appreciate the fact that
            you like to buy the stuff we build. We also want to make sure you
            have a rewarding experience while you&rsquo;re exploring,
        ...
        <p>
          <span>
            ...
            apply to transactions at Carter Boating. We&rsquo;ll be as brief as
            our attorneys will allow. The main thing to remember is that by
            placing an order or making a purchase at Carter Boating, you agree
            to the terms along with Carter Boating&rsquo;s Privacy Policy.
          </span>
        </p>
        <p>
          <br />
        ...
        <p>
          <span>
            ...
            (collectively, &quot;Suggestions&quot;) provided by you to Carter
            Boating with respect to the app shall remain the sole and exclusive
            property of Carter Boating.
          </span>
        </p>
        <p>
          <br />
        ...
        <p>
          <span>
            Carter Boating shall be free to use, copy, modify, publish, or
        ...
        <p>
          <span>
            ...
            and how it&apos;s being used. By using our app, registering an
        ...
        <p>
          <span>Links to Other Mobile applications</span>
        </p>
        <p>
          <span>
            This Terms &amp; Conditions applies only to the Services. The
            Services may contain links to other mobile applications not operated
            or controlled by Carter Boating. We are not responsible for the
            content, accuracy or opinions expressed in such mobile applications,
            and such mobile applications are not investigated, monitored or
            checked for accuracy or completeness by us. Please remember that
            when you use a link to go from the Services to another mobile
            application, our Terms &amp; Conditions are no longer in effect.
            Your browsing and interaction on any other mobile application,
            including those that have a link on our platform, is subject to that
            mobile application&rsquo;s own rules and policies. Such third
        ...
        <p>
          <span>
            Carter Boating uses &quot;Cookies&quot; to identify the areas of our
            app that you have visited. A Cookie is a small piece of data stored
            ...
            the app as we would not be able to remember that you had logged in
            ...
            access functionality on our app correctly or at all. We never place
        ...
        <p>
          <span>Changes To Our Terms &amp; Conditions</span>
        </p>
        <p>
          <span>
            You acknowledge and agree that Carter Boating may stop (permanently
            or temporarily) providing the Service (or any features within the
            Service) to you or to users generally at Carter Boating&rsquo;s sole
            discretion, without prior notice to you. You may stop using the
            Service at any time. You do not need to specifically inform Carter
            Boating when you stop using the Service. You acknowledge and agree
            that if Carter Boating disables access to your account, you may be
        ...
        <p>
          <span>Modifications to Our app</span>
        </p>
        <p>
          <span>
            Carter Boating reserves the right to modify, suspend or discontinue,
        ...
        <p>
          <span>Updates to Our app</span>
        </p>
        <p>
          <span>
            Carter Boating may from time to time provide enhancements or
        ...
        <p>
          <span>
            ...
            of the app. You agree that Carter Boating has no obligation to (i)
        ...
        <p>
          <span>
            ...
            services) or provide links to third-party mobile applications or
        ...
        <p>
          <span>
            You acknowledge and agree that Carter Boating shall not be
            ...
            decency, quality or any other aspect thereof. Carter Boating does
        ...
        <p>
          <span>
            Carter Boating may, in its sole discretion, at any time and for any
        ...
        <p>
          <span>
            ...
            Carter Boating, in the event that you fail to comply with any
            provision of this Agreement. You may also terminate this Agreement
            by deleting the app and all copies thereof from your computer.
          </span>
        </p>
        <p>
          <br />
        ...
        <p>
          <span>
            Termination of this Agreement will not limit any of Carter
            Boating&apos;s rights or remedies at law or in equity in case of
        ...
        <p>
          <span>Copyright Infringement Notice</span>
        </p>
        <p>
          <span>
        ...
        <p>
          <span>
            You agree to indemnify and hold Carter Boating and its parents,
            ...
            use of the app; (b) violation of this Agreement or any law or
        ...
        <p>
          <span>
            ...
            Carter Boating, on its own behalf and on behalf of its affiliates
            and its and their respective licensors and service providers,
            expressly disclaims all warranties, whether express, implied,
            statutory or otherwise, with respect to the app, including all
            ...
            practice. Without limitation to the foregoing, Carter Boating
            provides no warranty or undertaking, and makes no representation of
            any kind that the app will meet your requirements, achieve any
            intended results, be compatible or work with any other software,
            apps, systems or services, operate without interruption, meet any
        ...
        <p>
          <span>
            Without limiting the foregoing, neither Carter Boating nor any
            Carter Boating&apos;s provider makes any representation or warranty
            of any kind, express or implied: (i) as to the operation or
            availability of the app, or the information, content, and materials
            or products included thereon; (ii) that the app will be
            uninterrupted or error-free; (iii) as to the accuracy, reliability,
            or currency of any information or content provided through the app;
            or (iv) that the app, its servers, the content, or e-mails sent from
            or on behalf of Carter Boating are free of viruses, scripts, trojan
        ...
        <p>
          <span>
            ...
            liability of Carter Boating and any of its suppliers under any
        ...
        <p>
          <span>
            ...
            Carter Boating or its suppliers be liable for any special,
            ...
            related to the use of or inability to use the app, third-party
            software and/or third-party hardware used with the app, or otherwise
            in connection with any provision of this Agreement), even if Carter
            Boating or any supplier has been advised of the possibility of such
        ...
        <p>
          <span>
            ...
            notices published by Carter Boating on the Services, shall
            constitute the entire agreement between you and Carter Boating
            ...
            Carter Boating&rsquo;s failure to assert any right or provision
            under this Agreement shall not constitute a waiver of such right or
            provision. YOU AND Carter Boating AGREE THAT ANY CAUSE OF ACTION
        ...
        <p>
          <span>Amendments to this Agreement</span>
        </p>
        <p>
          <span>
            Carter Boating reserves the right, at its sole discretion, to modify
        ...
        <p>
          <span>
            ...
            agree to the new terms, you are no longer authorized to use Carter
            Boating.
          </span>
        </p>
        <p>
        ...
        <p>
          <span>
            ...
            Carter Boating regarding your use of the app and supersedes all

...
const ContactButton = ({ text1, text2 }) => {
  return (
    <Link
      href="/contact-us"
      className="bg-[#F15C20] text-white rounded-full text-center py-8 w-[20%]  hover:bg-black text-nowrap transition duration-300 relative group inline-block overflow-hidden"
    >
      {/* First text */}

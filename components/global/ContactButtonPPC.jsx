...
const ContactButtonPPC = ({ text1, text2 }) => {
  return (
    <Link
      href="/lp/contact-us"
      className="bg-[#F15C20] ppc-button text-white rounded-[12px] text-center py-7 px-16 md:py-8 md:px-20 hover:bg-black transition-all duration-300 relative group inline-block overflow-hidden"
    >
      {/* First text */}

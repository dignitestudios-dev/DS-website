...
const OurValueExpeditionSection = () => {
  return (
    <div className="py-20 global-padding-horizontal w-full grid grid-cols-1 lg:grid-cols-2 gap-x-6 gap-y-8">
      ...
      <div className="flex flex-col gap-4 lg:gap-12">
        <h1 className="text-3xl lg:text-[68px] 2xl:text-[94px] font-bold text-[#F15C20]">
          Our Value
        </h1>
        <h1 className="text-3xl lg:text-[68px] 2xl:text-[94px] font-bold 2xl:mt-3">
          Expedition
        </h1>

...
const Hero = () => {
  return (
    <div className="w-full text-center h-[65vh] md:h-[90vh] lg:h-screen relative pb-20 pt-2 md:pt-10 global-padding-horizontal flex flex-col items-center lg:mb-14 z-0">

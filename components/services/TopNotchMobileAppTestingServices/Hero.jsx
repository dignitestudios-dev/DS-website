...
const Hero = () => {
  return (
    <div className="w-full text-center h-[60vh] md:h-[90vh] lg:h-screen 2xl:h-[80vh] relative pb-20 pt-28 md:pt-40 global-padding-horizontal flex flex-col items-center lg:mb-14 z-0">

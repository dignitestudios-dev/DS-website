...
const Hero = () => {
  return (
    <div className="text-center pb-0 h-[60vh] lg:h-screen relative py-20 global-padding-horizontal flex flex-col items-center mb-14 z-0">
      ...
      <img
        ...
        className="lg:w-[1170px] lg:h-[709.52px] absolute top-52 lg:top-14 mx-auto"
      />
    </div>
  );
};

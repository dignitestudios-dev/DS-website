      ...
      <section className="w-full grid grid-cols-1 lg:grid-cols-3 gap-y-6">
        <div className="col-span-3 lg:col-span-2">
          ...
          <p className="text-lg font-normal mt-4">
            We create accelerated methodologies to revolutionize <Link href="/services/native-app-development" className="text-[#F15C20]">native mobile
            app development processes</Link> for more competent and adequate solutions
            for apps. With sterling <Link href="/services/native-app-development" className="text-[#F15C20]">native mobile app frameworks</Link> we build a
            sleek and tranquil process to refine and make development quicker
            for <Link href="/services/android-app-development" className="text-[#F15C20]">Android apps</Link> and <Link href="/services/ios-app-development" className="text-[#F15C20]">iOS devices</Link>.
          </p>
        </div>
      ...
      <div className="w-full mt-6 lg:py-2 grid grid-cols-1 gap-2 lg:gap-0 md:grid-cols-2 xl:grid-cols-3 md:grid-rows-3 lg:grid-rows-2 xl:mt-10">
        ...
        >
          <div className="w-full flex flex-col gap-2 md:gap-2 justify-start items-start">
            ...
            >
              To build highly intuitive <Link href="/services/native-app-development" className="text-gray-200 group-hover:text-white">native mobile applications</Link> we conduct
        ...
        >
          <div className="w-full flex flex-col gap-2 md:gap-2 justify-start items-start">
            ...
            >
              The top-notch <Link href="/services/android-app-development" className="text-gray-200 group-hover:text-white">Android</Link> and <Link href="/services/ios-app-development" className="text-gray-200 group-hover:text-white">iOS developers</Link> of Dignite Studios have

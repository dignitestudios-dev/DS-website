      ...
      <section className="w-full grid grid-cols-1 lg:grid-cols-3 gap-y-6">
        <div className="col-span-3 lg:col-span-2">
          ...
          <p className="text-lg font-normal mt-4">
            Among premier <Link href="/services/mobile-app-development" className="text-[#F15C20]">mobile app development companies</Link>, we batten
            exceptional assistance on a wider scale to flourish <Link href="/services/android-app-development" className="text-[#F15C20]">Android</Link> and <Link href="/services/ios-app-development" className="text-[#F15C20]">iOS</Link>
            devices internationally. From the start to the launch of <Link href="/services/mobile-app-development" className="text-[#F15C20]">mobile
      ...
      <div className="w-full grid grid-cols-1 lg:grid-cols-3 gap-6 mt-8">
        <div className="col-span-3 lg:col-span-1">
          ...
          >
            ...
            large enterprises. Our <Link href="/services/native-app-development" className="text-[#F15C20]">native mobile app development services</Link> create
            ...
            production of <Link href="/services/mobile-app-development" className="text-[#F15C20]">mobile applications</Link> for both <Link href="/services/ios-app-development" className="text-[#F15C20]">iOS</Link> and <Link href="/services/android-app-development" className="text-[#F15C20]">Android</Link> <Link href="/services/native-app-development" className="text-[#F15C20]">native
      ...
      <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-12">
        <div className="col-span-3 lg:col-span-1">
          ...
          >
            ...
            gilt-edged <Link href="/services/ios-app-development" className="text-[#F15C20]">iOS native applications</Link>. It enables the fastest <Link href="/services/mobile-app-development" className="text-[#F15C20]">software
            development process</Link> for <Link href="/services/ios-app-development" className="text-[#F15C20]">iOS apps</Link> with two Apple programming
            languages by which you can build a smooth application architecture
            for your mobile app. Our <Link href="/services/native-app-development" className="text-[#F15C20]">native app services</Link> bestow the highest
            quality <Link href="/services/native-app-development" className="text-[#F15C20]">native app development frameworks</Link> to enhance <Link href="/services/ios-app-development" className="text-[#F15C20]">iOS platforms</Link>
            ...
            error-free <Link href="/services/ios-app-development" className="text-[#F15C20]">iOS native apps</Link>.
          </p>
        </div>
        <div className="col-span-3 lg:col-span-1">
          <div
          ...
          >
            <Link href="/services/native-app-development" className="text-[#F15C20]">Native apps for Android</Link> platforms are created using a streamlined,
            single-code development process. They form different approaches and
            specific <Link href="/services/android-app-development" className="text-[#F15C20]">Android programming languages</Link> i.e. Kotlin or Java. You can
            create <Link href="/services/native-app-development" className="text-[#F15C20]">native mobile apps</Link> for both mobile and desktop. When your app
            reaches the final development phase, you’ll simply submit it to the
            Google Play Store. <br />
            Dignite’s highly skillful <Link href="/services/hire-mobile-application-developers" className="text-[#F15C20]">Native App developers</Link> foster unique

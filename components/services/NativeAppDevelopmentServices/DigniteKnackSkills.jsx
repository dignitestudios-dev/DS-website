        ...
        <section className="w-full flex flex-col lg:flex-row items-start gap-y-6">
          <div className="w-full lg:w-[75%]">
            ...
            <p className="text-lg font-normal mt-4">
              ...
              more dependent on technology. Here, Dignite’s dedicated <Link href="/services/mobile-app-development" className="text-[#F15C20]">software
              development team</Link> provides the top benefits of <Link href="/services/native-app-development" className="text-[#F15C20]">native applications</Link>
              to bestow absolute <Link href="/services/mobile-app-development" className="text-[#F15C20]">mobile app solutions</Link> for <Link href="/services/ios-app-development" className="text-[#F15C20]">iOS</Link> and <Link href="/services/android-app-development" className="text-[#F15C20]">Android</Link>
              platforms. We offer services to expedite small and large
              enterprises for <Link href="/services/native-app-development" className="text-[#F15C20]">native mobile applications</Link> and non-native apps.
              Our user-centric <Link href="/services/native-app-development" className="text-[#F15C20]">native applications</Link> will skyrocket your business

  ...
  return (
    <div className="w-full grid grid-cols-1 lg:grid-cols-5 justify-start items-start gap-y-8 py-4 lg:py-12 px-4 md:px-12 lg:px-28">
      <div className="col-span-5 lg:col-span-3 flex flex-col justify-start items-start gap-y-4">
        ...
        >
          TURN YOUR CONCEPT  <br /> into functional <br /> <span className="group-hover:text-[#F15C20] transition-all duration-300">mobile Application</span>
        </h1>
        <p
          style={{
        ...
        >
          Dignite Studios ensures that your innovative concepts transform into successful mobile applications.
        </p>
        <Link
          href={"/contact-us"}

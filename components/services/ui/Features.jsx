          ...
          >
            {features?.map((feature, index) => (
              <SwiperSlide key={index}>
                <div className="bg-white mb-8 h-full rounded-[32px] border border-gray-200 p-8 flex flex-col items-center text-center transition-all duration-300 group hover:border-[#F15C20]/20 w-[300px] lg:min-h-[300px]">
                  {/* Icon Container */}

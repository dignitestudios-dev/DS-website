...
const Comparison = () => {
  const leftFeatures = [
    { title: "Browser-based experience", desc: "Accessed via any desktop or mobile browser" },
    { title: "Standard functionality", desc: "Core pages, forms, and content delivery" },
    { title: "Lower development complexity", desc: "Simpler stack, faster to build and launch" },
    { title: "Suitable for informational sites", desc: "Ideal for portfolios, brochures, and blogs" },
    { title: "Easy maintenance", desc: "Straightforward content updates and hosting" },
  ];

  const rightFeatures = [
    { title: "App-like experience", desc: "Installable, full-screen, and native feel" },
    { title: "Offline capabilities", desc: "Service workers cache content without internet" },
    { title: "Enhanced engagement", desc: "Push notifications and re-engagement tools" },
    { title: "Suitable for interactive platforms", desc: "Great for dashboards, tools, and e-commerce" },
    { title: "Improved mobile experience", desc: "Optimised performance on all mobile devices" },
  ];
  ...
  return (
    <section className="w-full bg-[#FFFFFF] py-[100px] flex flex-col items-center justify-center">
      <div className="w-full max-w-[1240px] px-4 md:px-0 flex flex-col items-center gap-[50px]">
        {/* Header Section */}
        <div className="flex flex-col items-center gap-[30px] max-w-[909px] text-center">
          <motion.h2
          ...
          >
            Traditional Websites <span className="text-[#F15C20]">vs</span> Progressive Web Apps
          </motion.h2>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            Businesses often evaluate whether a traditional website or a Progressive Web App better aligns with their customer experience and growth objectives.
          </motion.p>
        </div>
            ...
            <div className="w-full px-[20px] pb-[20px] pt-[20px] border-b border-[#0C0C0C]/10 flex flex-row items-center gap-[20px]">
              ...
              <div className="flex flex-col gap-[8px]">
                ...
                <p className="font-light text-[14px] leading-[136%] tracking-[-0.014em] text-[#0C0C0C]">
                  Static or CMS-driven web presence
                </p>
              </div>
            </div>
              ...
              {leftFeatures.map((item, index) => (
                ...
                >
                  ...
                  <div className="flex flex-col gap-[6px]">
                    ...
                    <p className="font-normal text-[14px] leading-[136%] tracking-[-0.014em] text-[#0C0C0C]/80">
                      {item.desc}
                    </p>
                  </div>
                </div>
          ...
          >
            ...
            <div className="w-full px-[20px] pb-[20px] pt-[20px] border-b border-[#0C0C0C]/10 flex flex-row items-center gap-[20px]">
              ...
              <div className="flex flex-col gap-[8px]">
                ...
                <p className="font-light text-[14px] leading-[136%] tracking-[-0.014em] text-[#0C0C0C]">
                  App-grade experience in the browser
                </p>
              </div>
            </div>

        ...
        <div className="w-full min-h-[444px] bg-gradient-to-r from-[#3D3D3D] via-[#0C0C0C] to-[#3D3D3D] rounded-[32px] flex flex-col lg:flex-row items-center justify-between p-8 lg:p-[60px] relative overflow-hidden shadow-xl">
          ...
          <div className="flex flex-col gap-[25px] w-full lg:w-[552px] relative z-10">
            <h2 className="font-bold text-[36px] md:text-[45px] leading-[105%] tracking-[-0.04em] text-white opacity-90">
              It’s Time to Improve Your <span className="text-[#F15C20]">Website Performance</span>
            </h2>
            <p className="font-normal text-[16px] leading-[120%] tracking-[-0.014em] text-white/70 max-w-[500px]">
              If you are planning a new website or want to improve an existing website, our experts are there for you, providing the best web development consulting services. The right development team can make a major difference in performance.
            </p>
            <div className="mt-[10px]">
              <Link href="/contact-us" className="flex items-center group w-fit">
          ...
          {/* Right Mockup */}
          <div className="relative w-full lg:w-[450px] h-[300px] lg:h-[350px] mt-10 lg:mt-0 z-10 flex justify-center items-center">

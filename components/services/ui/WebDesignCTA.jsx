  ...
  return (
    <section className="w-full bg-[#FFFFFF] py-20 flex justify-center items-center overflow-hidden">
      <div className="relative w-full max-w-[1240px] px-4 md:px-0">
        ...
        {/* Main CTA Container */}
        <div className="w-full min-h-[444px] rounded-[32px] border border-[#EDEFF3] flex flex-col items-center justify-center p-8 lg:p-[60px] relative overflow-hidden shadow-xl"
          ...
          {/* Grid Image Overlay - using a subtle grid CSS for the grid effect */}
          ...
          {/* Content Wrapper */}
          <div className="flex flex-col items-center justify-center gap-[25px] w-full max-w-[854px] relative z-10">
            
            {/* Title */}
            <h2 className="font-bold text-[36px] md:text-[45px] leading-[105%] tracking-[-0.04em] text-white opacity-85 text-center">
              {title || <>Ready to Accelerate <br className="hidden md:block" /> Your Business Growth?</>}
            </h2>
            
            {/* Paragraph */}
            <p className="font-normal text-[16px] leading-[120%] tracking-[-0.014em] text-white opacity-70 text-center w-full">
              {desc || "It’s completely fair to overthink your decision because choosing a mobile application development Boston team is a big decision. Let’s talk through if you have questions or concerns before moving forward."}
            </p>

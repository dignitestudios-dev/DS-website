  ...
  return (
    ...
    >
      <div className={`text-center`}>
        ...
        <h2
          className={`lg:font-bold mt-3 uppercase font-extrabold text-4xl  xl:text-4xl 2xl:text-[54px] 2xl:mt-5  tracking-tighter`}
        >
          our clients
        </h2>
      </div>
      ...
      <div className={`w-full pt-4 lg:pt-16 gap-10 overflow-hidden`}>

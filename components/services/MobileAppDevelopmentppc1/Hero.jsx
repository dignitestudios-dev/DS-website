...
<div className='flex items-center justify-center' >
        ...
        <div className="w-full bg-purple1-img flex items-center justify-center">          
          <div><img src="/schedule.webp"  alt="" aos="translate-left"  data-aos="translate-left" data-aos-duration="500"  data-aos-easing="ease-in-sine" srcset="" className="schedule-img-left" /></div>
          <div><img src="/health-feed.webp" alt="" aos="translate-center" data-aos="translate-center" data-aos-duration="500"  data-aos-easing="ease-in-sine" className='health-feed-center' /></div>
          <div><img src="/plan.webp" alt="" aos="translate-right" data-aos="translate-right" data-aos-duration="500"  data-aos-easing="ease-in-sine" className="plan-img-right" /></div>

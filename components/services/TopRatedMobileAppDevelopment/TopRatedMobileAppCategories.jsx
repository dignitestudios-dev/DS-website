      ...
      <div className="w-full flex items-center justify-center gap-10 flex-wrap mt-6">
        <div className="w-full lg:w-[345px] 2xl:w-[445px] overflow-hidden bg-[#241C40] rounded-[24px] p-10 relative h-[425px] 2xl:h-[500px] group">
          ...
          <img
            ...
            alt="two mockup screens showing streaming mobile app development"
            title="Streaming mobile app development"
            className="w-[349.72px] h-[455.75px] 2xl:h-[535px] 2xl:w-[400px] absolute -bottom-36 -right-10 group-hover:-bottom-28 transition duration-300"
          />
        </div>
        <div className="w-full lg:w-[345px] 2xl:w-[445px] overflow-hidden bg-[#0983F4] rounded-[24px] p-10 relative h-[425px] 2xl:h-[500px] group">
          ...
          <img
            ...
            className="w-full h-[490.98px] 2xl:h-[665px] absolute -bottom-48 2xl:-bottom-[270px] 2xl:-right-20 -right-14 group-hover:-bottom-40 2xl:group-hover:-bottom-[248px] transition duration-300"
          />
        </div>
        <div className="w-full lg:w-[345px] 2xl:w-[445px] overflow-hidden bg-[#07D98D] rounded-[24px] p-10 relative h-[425px] 2xl:h-[500px] group">
          ...
          <img
            ...
            className="h-[431.37px] w-full 2xl:h-[575px] absolute -bottom-32 2xl:-bottom-44 -right-14 group-hover:-bottom-24 2xl:group-hover:-bottom-36 transition duration-300"
          />
        </div>
        <div className="w-full lg:w-[345px] 2xl:w-[445px] overflow-hidden bg-[#FEAE12] rounded-[24px] p-10 relative h-[425px] 2xl:h-[500px] group">
          ...
          <img
            ...
            className="w-[400px] 2xl:h-[530.98px] 2xl:w-[560.98px] absolute -bottom-32 -right-14 group-hover:-bottom-24 2xl:-right-20 2xl:-bottom-36 2xl:group-hover:-bottom-32 transition duration-500"
          />
        </div>
        <div className="w-full lg:w-[345px] 2xl:w-[445px] overflow-hidden bg-[#F4096C] rounded-[24px] p-10 relative h-[425px] 2xl:h-[500px] group">
          ...
          <img
            ...
            className="w-full h-[490.98px] 2xl:h-[595px] 2xl:w-[400px] absolute -bottom-48 -right-14 group-hover:-bottom-40 transition duration-300"
          />
        </div>
        <div className="w-full lg:w-[345px] 2xl:w-[445px] overflow-hidden bg-[#9875FD] rounded-[24px] p-10 relative h-[425px] 2xl:h-[500px] group">
          ...
          <img
            ...
            className="w-[400.67px] h-[490.98px] 2xl:h-[585px] 2xl:w-[400px] absolute -bottom-48 -right-12 group-hover:-bottom-40 transition duration-300"
          />
        </div>
      </div>
    </div>

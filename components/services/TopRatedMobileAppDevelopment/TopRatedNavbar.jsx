    ...
    >
      ...
      >
        ...
        >
          ...
          <div
            className={`w-64 h-auto p-6  rounded-2xl text-md scale-0 transition duration-150 group-hover:scale-100 flex  flex-col gap-2 justify-start items-start absolute top-full z-20 ${
              theme == "dark"
        ...
        <button
          onClick={() => navigateTo("/lp/contact-us")}

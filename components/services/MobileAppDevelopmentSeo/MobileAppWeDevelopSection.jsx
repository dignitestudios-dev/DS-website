  ...
  return (
    <div className="px-4 md:px-12 lg:px-28 xl:px-[120px] 2xl:px-48 flex flex-col gap-4 justify-start items-center w-full my-6 md:my-12 lg:my-16">
      ...
      <div className="w-full flex items-center justify-center gap-10 flex-wrap mt-6">
        ...
        <div className="w-full lg:w-[345px] overflow-hidden bg-[#0983F4] rounded-[24px] p-10 relative h-[425px] group">
          <h1 className="text-white text-[22px] font-bold z-30">
            E-Commerce App
          </h1>
        ...
        <div className="w-full lg:w-[345px] overflow-hidden bg-[#07D98D] rounded-[24px] p-10 relative h-[425px] group">
          <h1 className="text-white text-[22px] font-bold z-30">
            Insurance App
          </h1>
        ...
        <div className="w-full lg:w-[345px] overflow-hidden bg-[#F4096C] rounded-[24px] p-10 relative h-[425px] group">
        ...
        <div className="w-full lg:w-[345px] overflow-hidden bg-[#9875FD] rounded-[24px] p-10 relative h-[425px] group">
          <h1 className="text-white text-[22px] font-bold z-30">
            Telehealth App
          </h1>

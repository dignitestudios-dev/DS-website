...
const CTA = () => {
  return (
    <div className="-mt-12 lg:-mt-28 -mb-8 lg:-mb-16 w-[95%] h-[550px] lg:w-[80%] text-black md:text-white md:bg-[url('/services/hybrid-app/s-cta.webp')] bg-contain bg-no-repeat bg-center transition ease-linear relative 2xl:px-40 md:px-28 px-10 md:my-0 md:py-14 mx-auto overflow-hidden flex justify-center items-center">
      ...
      <div className="flex flex-row-reverse justify-between items-center relative z-20">
        <div className="hidden lg:block lg:w-[40%] ">
          <motion.img
            src="/services/hybrid-app/cta-m.webp"
            alt="cta-mobile"
            className="-mb-11 2xl:-mb-16"
        ...
        <div className="w-full lg:w-[50%] ">
          ...
          <p>
          Many brands hire hybrid app developers for the best hybrid mobile app development services to grow and succeed. Yours could be next!
          </p>
          <Link
            href="/contact-us"

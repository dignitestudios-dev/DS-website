  ...
  return (
    <div className=" w-full flex flex-col items-center">
      ...
      <div className="flex relative z-20 w-[90%] md:w-[80%] lg:w-[850px] flex-col text-center mx-auto items-center mt-12 mb-10">
        ...
        >
          Custom Web <span className="text-[#F15C20]">Development</span> Services
        </motion.h1>
        <motion.p
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          Custom web development services mainly help businesses create user friendly and fast loading websites. These websites help you increase conversions and strengthen online visibility. It also impact your future growth through optimized performance.
        </motion.p>
      ...
      <div className="relative flex justify-center w-full px-4 md:px-0 mt-8  z-20">
        ...
        >
          <Image
            src="/services/web-design/hero-mockup.webp"

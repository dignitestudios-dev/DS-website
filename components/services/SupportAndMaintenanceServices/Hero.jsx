...
const Hero = () => {
  ...
  return (
    <main className="w-full  flex flex-col pt-2 md:pt-10  gap-4 justify-start items-center">
      ...
      <h2 className={`text-base font-normal ${''}`}>Get free maintenance and support service from our top experts.</h2>
      <div>
        <Link
          href={"/contact-us"}
          className="bg-[#F15C20] text-white w-[164px] h-[64px] rounded-full text-center"
        >

...
const CTA = () => {
  return (
    <div className="w-[95%] h-[450px] lg:h-[550px] lg:w-[80%] rounded-2xl lg:rounded-none bg-black lg:bg-transparent text-white md:bg-[url('/services/mobile-app/s-cta.png')] bg-contain bg-no-repeat bg-center transition-all ease-linear relative 2xl:px-40 md:px-28 px-10 md:my-0 md:py-14 mx-auto overflow-hidden flex justify-center items-center">
      ...
      <div className="flex flex-row-reverse items-center relative z-20">
        <div className="hidden lg:block lg:w-[40%] ">
          <motion.img
            src="/services/web-app/cta-m.png"
            alt="cta-mobile"
            className=""

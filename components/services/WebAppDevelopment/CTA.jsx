...
const CTA = () => {
  return (
    <div className="w-[95%] h-[450px] lg:h-[550px] lg:w-[80%] rounded-2xl lg:rounded-none bg-black lg:bg-transparent text-white md:bg-[url('/services/mobile-app/s-cta.webp')] bg-contain bg-no-repeat bg-center transition-all ease-linear relative 2xl:px-40 md:px-28 px-10 md:my-0 md:py-14 mx-auto overflow-hidden flex justify-center items-center">

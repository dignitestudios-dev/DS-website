...
const CTA = () => {
  return (
    <div className="-mt-12 lg:-mt-28 -mb-8 lg:-mb-16 w-[95%] h-[450px] lg:h-[550px] lg:w-[80%] rounded-2xl lg:rounded-none bg-black lg:bg-transparent text-white md:bg-[url('/services/mobile-app/s-cta.webp')] bg-contain bg-no-repeat bg-center transition ease-linear relative 2xl:px-40 md:px-28 px-10 md:my-0 md:py-14 mx-auto overflow-hidden flex justify-center items-center">
      ...
      <div className="flex flex-row-reverse items-center relative z-20">
        <div className="hidden lg:block lg:w-[40%] ">
          <motion.img
            src="/services/web-app/cta-m.webp"
            alt="cta-mobile"
            className=""
        ...
        <div className="w-full lg:w-[60%] lg:pr-16">
          ...
          <p>
            You’ve seen how the right solution can work for any business. Now
            imagine what we can do for yours. We’re ready to help you create a
            web application just like the projects you’ve explored above.
          </p>
          <Link
            href="/contact-us"

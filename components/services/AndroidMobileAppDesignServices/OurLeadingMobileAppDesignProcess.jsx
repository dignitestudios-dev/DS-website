...
const OurLeadingMobileAppDesignProcess = () => {
      ...
      <section className="w-full grid grid-cols-1 lg:grid-cols-3 gap-y-6">
        <div className="col-span-3 lg:col-span-2">
          <p className="uppercase font-bold text-xl text-[#8F8F8F]">
            Our Leading mobile app
          </p>
          <h2 className="headings-size mt-2">
            Design <span className="text-[#F15C20]">Process</span>
          </h2>
          <p className="text-lg font-normal mt-4">
            We harness tried-and-tested strategies to streamline the Android app
            design process in full stack. To ensure the app functionality and
            comprehensive design architecture of Android mobile app development,
            Dignite’s team implements suitable related services to make UI and
            UX design hassle-free and competent.
          </p>
        </div>
...
export default OurLeadingMobileAppDesignProcess;

...
import SEOServicesCTA from "../ui/SEOServicesCTA";
...
const toolsData = [
    {
        ...
        icon: "/services/seo-services/gsc.webp"
    },
    {
        name: "Google Analytics 4", icon: "/services/app-marketing-services/g.webp"
    },
    {
        name: "Ahrefs", icon: "/services/seo-services/ahrefs.webp"
    },
    {
        name: "SEMrush", icon: "/services/seo-services/sem.webp"
    },
    {
        name: "Screaming Frog", icon: "/services/seo-services/sfc.webp"
    },
    {
        name: "Google Keyword Planner", icon: "/services/seo-services/gk.webp"
    },
    { name: "Google Trends", icon: "/services/app-marketing-services/gt.webp" },
    {
        name: "PageSpeed Insights", icon: "/services/seo-services/pgi.webp"
    },
    {
        name: "Microsoft Clarity", icon: "/services/seo-services/mc.webp"
    },
...
const metricsHighlights = [
    {
        icon: "/services/seo-services/ser.webp",
        title: "Search Engine Rankings",

    },
    {
        icon: "/services/seo-services/ot.webp",
        title: "Organic App Downloads",

    },
    {
        icon: "/services/seo-services/ais.webp",
        title: "AI Search Visibility",

    },
    {
        icon: "/services/seo-services/ctr.webp",
        title: "Click-Through Rate (CTR)",

    },
    {
        icon: "/services/seo-services/olg.webp",
        title: "Organic Lead Generation",

    },
    {
        icon: "/services/seo-services/da.webp",
...
const whyChooseHighlights = [
    {
        ...
        number: "01",
        title: "SEO Strategies Built for Modern Search",
    ...
    },
    {
        ...
        number: "02",
        title: "Expertise in Traditional & AI Search",
    ...
    },
    {
        ...
        number: "03",
        title: "Proven Organic Growth Frameworks",
    ...
    },
    {
        ...
        number: "04",
        title: "Technical & Content SEO Specialists",
    ...
    },
    {
        ...
        number: "06",
        title: "Long-Term SEO Growth Focus",
...
export const cardsData = [
    {
        image: '/services/seo-services/e.webp',

        heading: "Traditional Search Visibility",
        para:
            "Improve rankings and organic traffic through technical SEO, content optimization, and authority-building strategies designed to increase search engine performance.",
    },
    {
        image: '/services/seo-services/so.webp',
        heading: "AI Search Optimization",
        para:
            "Optimize content for AI-generated answers, AI Overviews, and conversational search experiences to improve visibility beyond traditional search rankin",
    },
    {
        image: '/services/seo-services/si.webp',
        heading: "Search Intent Alignment",
        para:
            "Create content that directly answers user questions and aligns with how people search across both search engines and AI assistants.",
    },
    {
        image: '/location/mobile-california/icons/clv.webp',
        heading: "Authority & Trust Signals",
        para:
            "Strengthen credibility through high-quality content, expertise signals, and authoritative backlinks that influence search engines and AI platforms.",
    },
    {
        image: '/services/seo-services/eb.webp',
        heading: "Entity & Brand Optimization",
        para:
            "Build a strong digital presence that helps search engines and AI systems understand your brand, products, services, and expertise.",
    },
    {
        image: '/services/seo-services/sg.webp',
        heading: "Sustainable Organic Growth",
        para:
            "Develop long-term SEO strategies that drive consistent visibility, traffic, and lead generation as search technologies continue to evolve.",
    },
];

const SEOMarketingServices = () => {
    return (
        <div className="max-w-screen-2xl mx-auto gap-20 lg:gap-36 w-full h-auto flex flex-col items-center justify-start overflow-x-hidden overflow-y-auto">
            ...
            <About
                ...
                heading2="Services"
                para={
                    <>At Dignite Studios, we help businesses achieve sustainable online growth through results-driven SEO services backed by over 10 years of industry experience. Our SEO strategies are designed to improve organic visibility, attract qualified traffic, and turn search intent into measurable business outcomes. From optimizing performance on traditional search engines to enhancing discoverability in emerging AI-powered search experiences, we ensure your brand stays ahead of evolving search behaviors. Using data-driven insights and proven optimization techniques, we focus on lead generation, customer acquisition, and revenue growth. Every strategy is tailored to your goals, delivering measurable improvements, long-term ROI, and a stronger digital presence that scales with your business.
                    </>
                }
                button="Talk to Our SEO Experts"
            />
            <FeatureCard
                featureData={cardsData}
                header="Comprehensive SEO "
                header2="Services"
                ...
                button="Future-Proof Your SEO Strategy"
            />
            <Services
                header="Comprehensive SEO "
                header2="Services"
                para="Our team also delivers the modern mobile products which are built with the flutter for the speed, performance and the scalability. Dignite studios designs the top flutter app development services for the startups and enterprises that want the long term value and reliable cross platform experiences."
                button="Improve Your Search Visibility"
            ...
            /> */}
            <ToolsAndTech
                header="SEO Tools & Technologies We "
                header2="Use"
                subtitle="Dignite Studios leverages industry-leading SEO tools, analytics platforms, technical auditing software, and search intelligence solutions to maximize organic visibility and performance."
                tools={toolsData}
            />
            <Process
                ...
                para="Our structured growth strategy consulting process helps businesses identify opportunities, prioritize initiatives, and execute scalable growth plans with measurable outcomes."
            />
            <MetricsCarousel
                header="Key SEO Metrics We Help  "
                header2="Improve"
                button="Improve Your SEO Performance"
                para="Successful SEO is measured through visibility, traffic, engagement, and business growth. We focus on improving the metrics that directly impact long-term organic performance."
                data={metricsHighlights}
            />
            {/* <Comparison /> */}
            <Bussiness
            ...
            <Testimonials
                header2="Services"
                header="What Clients Say About Our SEO "
...
export default SEOMarketingServices;

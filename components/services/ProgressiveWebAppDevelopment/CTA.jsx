...
const CTA = () => {
  return (
    <div className="w-[95%] h-[550px] lg:w-[80%] text-black md:text-white md:bg-[url('/services/pwa-app/s-cta.webp')] bg-contain bg-no-repeat bg-center transition ease-linear relative 2xl:px-40 md:px-28 px-10 md:my-0 md:py-14 mx-auto overflow-hidden flex justify-center items-center">

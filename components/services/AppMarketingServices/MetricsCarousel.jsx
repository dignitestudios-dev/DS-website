...
const MetricCard = ({ item }) => (
    <article className="relative w-[250px] h-[280px] bg-white rounded-2xl border border-[#D3D3D8] p-6 pt-14 shadow-sm hover:shadow-lg transition  flex flex-col items-center">

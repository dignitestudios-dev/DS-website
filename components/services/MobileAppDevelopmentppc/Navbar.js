    ...
    >
      ...
      >
        ...
        >
          ...
          <IoIosArrowDown
            className={`text-md ${
              showDropdown ? "rotate-180 transition duration-300" : ""
            }`}
          />
        </button>
        <button
      ...
      {showDropdown && (
        <div
          ...
          className={`w-[100%] min-h-[369px] p-6 z-50 text-md transition duration-150 hidden lg:flex gap-2 justify-center lg:gap-x-8 xl:gap-x-20 pt-10 items-start absolute top-20 left-1/2 transform -translate-x-1/2  ${

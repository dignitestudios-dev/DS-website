...
const RecentShowCase = () => {
  ...
  return (
    <section id="recentShowCase" className="px-4 md:px-12 lg:px-28 xl:px-[120px] 2xl:px-48 flex flex-col gap-4 justify-start items-center w-full  mb-10  lg:mt-10 lg:mb-20  ">
        ...
        <div className="lg:w-[70%] xl:w-[80%]  flex flex-col gap-y-6 lg:gap-y-2">
          ...
          >
            <span className="text-[#F15C20] text-[20px] font-[700] tracking-wide leading-[28px] upper">Recent
              <img src="/mainUnder.webp" className='' alt="RecentShowCase MainUnder" srcset="" />
            </span>
            <div className='mt-5' >
              Case Studies
            </div>

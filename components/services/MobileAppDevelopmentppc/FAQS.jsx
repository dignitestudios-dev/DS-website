...
import { MobileAppDevelopmentPpcFaq } from "@/constants/mobile-app-development-ppc";
...
const FAQS = () => {
  ...
  return (
    <section
      ...
      } w-full global-padding-horizontal py-10 lg:py-20 pb-10 lg:pb-20 mt-28  rounded-[48px] flex justify-center items-start mx-auto h-auto`}
    >
      <div className="w-full h-auto flex flex-col gap-3 justify-start items-center">
        ...
        >
          {MobileAppDevelopmentPpcFaq.map((faq, index) => {
            return (
              <div
                type="button"
                key={index}
              ...
              >
                ...
                >
                  <div
        className={`border ${theme === "dark" ? "border-gray-300" : "border-[#E7E7E7]"
          } w-full mb-4 mt-6`}
      />

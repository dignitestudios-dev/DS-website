...
const AmaizingShowCase = () => {
  ...
  return (
    <section className={`global-padding-horizontal py-10 lg:py-20 relative md:pb-[100px] ${
      theme === "light" ? "bg-[#FBFBFB]" : "bg-[#2d2d2d]"
    }  rounded-[80px] flex flex-col gap-4 justify-start items-center w-full mt-[30px] lg:mt-[30px]  lg:mt-16 `}>
        ...
        <div className="lg:w-[70%] xl:w-[80%] flex flex-col gap-y-6 lg:gap-y-2">
          <h2
            className={`${theme === "dark" ? "text-white" : "text-black"
              } text-5xl capitalize font-[600]  headings-size `}
          >
          ...
          <p
            className={`text-base w-[100%] lg:w-[65%] font-normal mt-1 text-start ${theme === "light" && "text-[#2A2A2A]"
              }`}
          >

...
const Hero = () => {
  ...
  return (
    <main className="w-full h-[105vh] 2xl:h-[80vh] flex flex-col pt-28 md:pt-40  gap-4 justify-start items-center overflow-x-hidden xl:global-padding-horizontal text-center">
      <h1
        style={{
          color: palette?.color,
        }}

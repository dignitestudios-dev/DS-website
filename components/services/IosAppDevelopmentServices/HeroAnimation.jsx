    ...
    <div className="w-full mt-60 lg:mt-20 flex">
      ...
      <div className="container lg:w-[30%] mx-auto relative">
        <img
          ...
          alt="apple_icon_silver"
          title="apple_icon_silver"
          className={`w-[72px] h-[86px] apple-icon  ${
            showIcons ? "   " : "mt2"
          }`}
        />
        <img
        ...
        {showIcons && (
          <img
            ...
            className={`w-[63px] h-[63px] z-10 absolute top-1/2 left-1/2 ${
              showIcons && "icon-1   icon-rotate"
            } z-0 ${addSecondClass && "object_card"} `}
          />
        )}
        {showIcons && (
          <img
            ...
            alt="itunes-icon"
            title="itunes-icon"
            className={`w-[68px] h-[68px] absolute top-1/2 left-1/2 ${
              showIcons && "icon-2 icon-rotate"
            } z-0 ${addSecondClass && "object_card1"}`}
          />
        )}
        {showIcons && (
          <img
            ...
            className={`w-[68px] h-[68px] absolute top-1/2 left-1/2 ${
              showIcons && "icon-3 icon-rotate"
            } z-0 ${addSecondClass && "object_card2"}  `}
          />
        )}
        {showIcons && (
          <img
            ...
            className={`w-[68px] h-[68px] absolute top-1/2 left-1/2 ${
              showIcons && "icon-4 icon-rotate"
            } z-0 ${addSecondClass && "object_card3"} `}
          />
        )}
        {showIcons && (
          <img
            ...
            className={`w-[68px] h-[68px] absolute top-1/2 left-1/2 ${
              showIcons && "icon-5 icon-rotate"
            } z-0 ${addSecondClass && "object_card4"}  `}
          />
        )}
      </div>

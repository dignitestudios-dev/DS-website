    ...
    <section className="w-full global-padding-horizontal py-12 lg:py-24 2xl:py-28 grid grid-cols-1 xl:grid-cols-3 gap-10">
      <div className="w-full col-span-3 xl:col-span-1 flex flex-col items-start gap-4">
        ...
        <div className="mt-3">
          {/* <Link
            href={"/contact-us"}
            className="py-[20px] px-[30px] xl:py-[28px] xl:px-[60px] rounded-full text-white bg-[#F15C20] text-base md:text-xl font-semibold flex items-center justify-center gap-2 top-rated-btn-shadow hover:opacity-85 transition duration-200"
          >
      ...
      <div className="w-full col-span-3 xl:col-span-2">
        <div className="w-full flex flex-col items-start gap-2">
          ...
          >
            ...
            <Link href="/services/android-app-development" className="text-[#F15C20]">custom Android app development company</Link> maintains potent strategies
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-10 mt-6 lg:mt-10">
          ...
          <div className="w-full flex flex-col items-start gap-2">
            ...
            >
              Top-notch trusted <Link href="/services/android-app-development" className="text-[#F15C20]">Android application development company</Link> Dignite

...
const TopAndroidAppSection = () => {
  ...
  return (
    ...
    >
      ...
      >
        The <Link href="/services/android-app-development" className="text-[#F15C20]">custom Android app development company</Link> Dignite Studios depicts an
        ...
        and <Link href="/services/android-app-development" className="text-[#F15C20]">Android apps</Link>.
      </p>
      ...
      <div className="w-full lg:max-w-[1000px] hidden md:grid md:grid-cols-2 grid-cols-1 gap-10">
        <div className="text-start pt-4">
          ...
          >
            <Link href="/services/android-app-development" className="text-[#F15C20]">Native Android development</Link> provide highly riched app features and
            exceptional mobile functions to scale your consumer app on a wider
            landscape. The <Link href="/services/mobile-app-development" className="text-[#F15C20]">best app development company</Link> Dignite Studios will
        ...
        <div className="text-start pt-4">
          ...
          >
            ...
            and <Link href="/services/android-app-development" className="text-[#F15C20]">native Android development</Link>. However, to make your app more
            ...
            Android platforms. Highly optimized <Link href="/services/android-app-development" className="text-[#F15C20]">Android application development services</Link> of Dignite Studios, impart first-rate development strategy
            to rame striking hybrid Android apps to furnish world-class <Link href="/services/android-app-development" className="text-[#F15C20]">Android app development solutions</Link> to generate mobile apps scalability.
          </p>
        </div>
      </div>

...
const CTA2 = ({
  ...
  return (
    <div>
      {" "}
      <div className="-mt-12 lg:-mt-28 -mb-8 lg:-mb-16 w-[95%]  md:h-[550px] lg:w-full text-white bg-black md:bg-transparent md:bg-[url('/ecommerce/shopify-app/s-cta2.webp')] md:bg-contain md:bg-no-repeat md:bg-center transition ease-linear rounded-2xl md:rounded-none relative px-6 md:px-36 py-10 md:py-14 mx-auto overflow-hidden">
        <div className="flex items-start h-full justify-center">
          <div className="hidden lg:block z-0 absolute -bottom-[35%] left-[65%] 2xl:left-[70%] -translate-x-1/2 w-full">
            <motion.img
              src="/ecommerce/shopify-app/mobiles.webp"
              alt="cta-mobile"
              className=""
          ...
          <div className="w-full lg:w-[80%] relative z-20 text-center">
            <h2 className="text-3xl md:text-5xl capitalize font-bold mb-4">
              {header}
            </h2>

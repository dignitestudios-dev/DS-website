    ...
    <section className="w-full  overflow-visible text-black">
      <div className="max-w-7xl mx-auto text-center px-4">
        <h2 className="text-4xl md:text-7xl leading-[42px] tracking-tighter lg:leading-[1.1] font-bold mb-6">
          ...
          <span className="text-[#F15C20]"> Technology Stack</span>
        </h2>

        <p className="font-extralight mx-auto mb-16 text-lg max-w-3xl">
          We use modern tools and platforms to build scalable ecommerce apps. As
          the reliable ecommerce app development company in USA, we focus on
          performance, security and smooth mobile app solutions for modern
          businesses.
        </p>

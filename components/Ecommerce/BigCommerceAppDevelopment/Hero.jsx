      ...
      <div className="relative flex  justify-center items-center my-12 ">
        ...
        >
          <Image
            ...
            alt="BigCommerce app development mockup showcase on laptop"
            width={900}
            height={900}
            priority
          ...
          <Image
            ...
            alt="BigCommerce app development mockup showcase on mobile"
            width={250}
            height={250}
            priority
        ...
        <motion.img
          ...
          alt="BigCommerce development services floating icon"
          width={150}
          height={150}
        ...
        <motion.img
          ...
          alt="BigCommerce development services decorative icon"
          width={150}
          height={150}

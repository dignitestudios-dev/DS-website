  ...
  features = [
    {
      ...
      description:
        "Every Solution Is Built From Scratch To Match The Exact Business Needs.",
    },
    {
      number: "02",
      title: "Specialized Engineering Teams",
      description:
        "Expert developers with focused technical skills and deep domain knowledge.",
    },
    {
      number: "03",
      title: "24/7 Support",
      description:
        "Round-the-clock availability for clients across different time zones and regions.",
    },
    {
      number: "04",
      title: "200+ Skilled Technology Experts",
      description:
        "Large pool of talented professionals with diverse technical expertise.",
    },
    {
      number: "05",
      title: "Flexible Engagement Models",
      description:
        "Various collaboration structures tailored to your project requirements.",
    },
    {
      number: "06",
          ...
          {features.map((feature, index) => (
            ...
            >
              ...
              >
                ...
                <div
                  className={`
                  mt-4 text-sm transition duration-300 overflow-hidden

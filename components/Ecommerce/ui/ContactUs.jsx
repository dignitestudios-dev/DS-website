...
const ContactUs = ({ pathname, header, img, header2, para, btn }) => {
 ...
 const [countryCode, setCountryCode] = useState("");
  ...
  return (
    <div className="w-full bg-[#0A0A0A] pt-24 sm:pt-32 [clip-path:ellipse(250%_100%_at_50%_100%)] md:[clip-path:ellipse(120%_100%_at_50%_100%)] relative grid grid-cols-1 pb-44 overflow-hidden md:py-32">
      <div className="flex justify-center w-[80%] mx-auto lg:justify-between items-center">
        <Image src="/location/contact-crnr.webp" alt="Contact Us" width={601} height={734} className="absolute right-0  lg:block hidden bottom-0 object-contain" />
          ...
          <form onSubmit={handleSubmit} className="space-y-6 max-w-lg mt-12">
            ...
            <div className="relative">
              <input
                ...
                placeholder=" "
              />
              <label htmlFor="name" htmlFor="name"   className="

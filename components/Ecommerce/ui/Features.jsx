          ...
          >
            {features?.map((feature, index) => (
              <SwiperSlide key={index}>
                <div className="bg-white mb-8  rounded-[32px] border border-gray-200 p-8 flex flex-col items-center text-center transition duration-300 group hover:border-[#F15C20]/20 w-[300px] h-[300px]">
                  {/* Icon Container */}

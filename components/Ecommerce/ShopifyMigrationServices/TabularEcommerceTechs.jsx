    ...
    <section className="w-full  overflow-visible text-black">
      <div className="max-w-7xl mx-auto text-center px-4">
        <h2 className="text-4xl md:text-7xl leading-[42px] tracking-tighter lg:leading-[1.1] font-bold mb-6">
           Shopify Migration {" "}
          <span className="text-[#F15C20]">Technologies  </span>
        </h2>

        <p className="font-extralight mx-auto mb-16 text-lg max-w-3xl">
         We use reliable tools and platforms to ensure smooth migrations. Our shopify migration service includes secure APIs, automation tools and tested systems. Our Shopify plus migration agency ensures the safe and efficient data transfers. 
        </p>

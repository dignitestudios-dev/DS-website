...
const CTA = ({
  ...
  return (
    <div className="w-[95%] h-[550px] lg:w-[80%] text-white md:bg-[url('/industries/food-industry/s-cta.webp')] bg-contain bg-no-repeat bg-center transition-all ease-linear relative md:px-36 px-10 md:my-0 md:py-14 mx-auto overflow-hidden">
      ...
      <div className="flex items-center h-full gap-12 justify-between">
        ...
        <Image  src={"/industries/food-industry/cta-mob.webp"} width={400} height={400} alt="CTA Image" />
      </div>
    </div>
  );
};

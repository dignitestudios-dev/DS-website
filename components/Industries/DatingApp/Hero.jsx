...
const Hero = ({
  header = "Your Trusted Dating App",
  header2 = "Development Company",
  para = " Finding a professional dating app development company? We’re the best choice for creating matchmaking apps. Dignite Studios provides different services in the category of dating app development with commitment. We are a team of dedicated app developers in the matchmaking industry. ",
...
<motion.div
  ...
  className="absolute top-[40%] -left-[35%] -bottom-10 z-20 m-auto hidden lg:block"
>
  <Image

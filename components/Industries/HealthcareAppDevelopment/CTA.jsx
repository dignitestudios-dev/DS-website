...
const CTA = ({
  header = "Transform Your Healthcare Services Today",
  para = "Work with Dignite Studios to build reliable healthcare apps that improve patient care and boost engagement. Let’s create healthcare solutions according to your needs.",
  btn = "Get Started Now",
}) => {


  return (
    <div className="-mt-12 lg:-mt-28 -mb-8 lg:-mb-16 w-[95%] h-[550px] lg:w-[80%] text-black md:text-white md:bg-[url('/industries/healthcare/s-cta.webp')] bg-contain bg-no-repeat bg-center transition ease-linear relative md:px-36 px-10 md:my-0 md:py-14 mx-auto overflow-hidden">

...
const CTA = ({
  ...
  return (
    <div className="w-[95%] h-[550px] lg:w-[80%] text-black md:text-white md:bg-[url('/industries/ent-app/s-cta.webp')] bg-contain bg-no-repeat bg-center transition ease-linear relative md:px-36 px-10 md:my-0 md:py-14 mx-auto overflow-hidden">

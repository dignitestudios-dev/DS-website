...
const IntegrationCard = ({ integration }) => {
  return (
    <div className="bg-white relative border-2 border-[#F15C20] rounded-3xl p-6 sm:p-8 w-[250px] h-[260px] flex flex-col items-center text-center hover:shadow-lg transition">
      {/* Icon Circle */}

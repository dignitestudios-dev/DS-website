...
const Hero = ({
  ...
  return (
   ...
   <motion.div 
    ...
    >
      <Image src={"/industries/ent-app/mob.webp"} className="hidden lg:block" alt="{para} - Mob" width={900} height={900} />
      <Image src={"/industries/ent-app/mob.webp"} className="lg:hidden block" alt="{para} - Mob" width={500} height={500} />
    </motion.div>

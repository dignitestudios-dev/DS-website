    ...
    <div className="w-full grid grid-cols-1 justify-start items-start ">
      ...
      <div className="hidden md:flex flex-wrap justify-center gap-4 w-[90%] 2xl:w-[80%] mx-auto">
        {services.map((service, index) => (
          ...
          >
            <div className="flex justify-center items-center p-4 shadow-2xl group-hover:shadow-white shadow-[#F15C20] rounded-[22px] group-hover:border-t-white group-hover:border-b-white bg-white/20 border-b border-b-[#F15C20] border-t-[#F15C20] mx-auto w-[20%] h-[70px] border-t">
              <img
                src={`/industries/ent-app/${service.icon}.webp`}
                alt={service.title}
                className="group-hover:hidden transition duration-300"
              />
              <img
                src={`/industries/ent-app/${service.icon2}.webp`}
                alt={service.title}

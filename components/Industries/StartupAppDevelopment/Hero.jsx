...
const Hero = ({
  header = "Strategic Mobile App Development For   ",
  header2 = "Startups",
  para = " The Mobile App Development For Startups covers everything including planning to launch. We create iOS and Android apps that fit and work according to your users and budget.",
    ...
    <div className="w-full grid grid-cols-1 bg-[url('/ecommerce/shopify-app/grad.webp')] bg-cover bg-center bg-no-repeat  justify-start items-start ">
      ...
      <div className="relative flex  justify-center items-center my-12 mt-20 ">
         <div className="relative flex items-center justify-center md:w-[600px] md:h-[600px] w-[250px] h-[250px] mx-auto">
          ...
          <Image
            src="/industries/real-state/ring.webp" alt="{para} - Ring"
            layout="fill"
            objectFit="contain"
          />
          <Image
...
>
  ...
  />
   ...
   <motion.div 
    ...
    >
      <Image src={"/industries/real-state/mob.webp"} className="hidden lg:block" alt="{para} - Mob" width={300} height={300} />
      <Image src={"/industries/real-state/mob.webp"} className="lg:hidden block" alt="{para} - Mob" width={150} height={150} />
    </motion.div>

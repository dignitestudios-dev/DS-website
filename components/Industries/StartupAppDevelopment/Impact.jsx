    ...
    <section className="w-full py-20 px-4 md:px-12 lg:px-28 xl:px-[120px] 2xl:px-48 bg-white dark:bg-black">
      <div className="text-center max-w-4xl mx-auto mb-16">
        <h2 className="text-[40px] md:text-[64px] font-bold text-black dark:text-white tracking-tighter leading-[1.1] mb-6">
         What Our Journey Looks Like in Numbers 
        </h2>
        <p className=" text-lg ">
       We have worked on multiple digital products for businesses from different industries and markets. The numbers below give you a quick look at the experience, projects and work that have shaped Dignite Studios over the years. 
        </p>
      </div>

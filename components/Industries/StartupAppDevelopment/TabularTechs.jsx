    ...
    <section className="w-full  overflow-visible text-black">
      <div className="max-w-7xl mx-auto text-center px-4">
        <h2 className="text-4xl md:text-7xl leading-[42px] tracking-tighter lg:leading-[1.1] font-bold mb-6">
          Our Technology Stack for Startup App Development 
        </h2>

        <p className="font-extralight mx-auto mb-16 text-lg max-w-3xl">
       The right technology stack can make a huge difference in how your app performs today and in the future. We use a wide range of modern technologies and development frameworks to build products based on your specific requirements.
        </p>

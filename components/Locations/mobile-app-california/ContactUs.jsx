...
const ContactUs = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    if (Object.keys(newErrors).length === 0) {
      ...
      data1.append("entry.764492805", "CTA from mobile app california"); // Page field
    ...
    <div className="w-full bg-gradient-to-t from-[#FFFDFA] to-[#FFFBFA] relative grid grid-cols-1  justify-start items-start md:py-20 ">
      ...
      <div className="flex justify-center w-[80%] mx-auto lg:justify-between items-center">
        <div className="lg:w-[50%]">
          <h1 className="text-4xl font-bold">Ready to Build Your App? </h1>
          <h1 className="text-4xl font-bold text-[#F15C20]">Let’s Talk</h1>
          <p>
            Don’t compromise on your app’s success. Gain a competitive edge. Our
            professional app developers California provide expertise,
            creativity, and reliability. Partner with a dedicated team of
            skilled app developers in California to launch your app faster and
            smarter.{" "}
          </p>

...
const CTA = () => {
  return (
    <div className="w-[95%] lg:w-[80%] text-white bg-[url('/location/mobile-texas/s-cta.webp')] bg-cover bg-center hover:scale-105 transition ease-linear relative md:px-14 px-10 my-24 md:my-0 py-24 mx-auto rounded-[43px] overflow-hidden border border-[#DDDDDD]">

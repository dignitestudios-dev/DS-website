  ...
  return (
    <div className="max-w-screen-2xl w-full h-auto flex flex-col justify-start mx-auto overflow-x-hidden overflow-y-auto">
      ...
      <Bussiness
        ...
        cta={
          <div className="bg-transparent h-[500px] hover:scale-105 z-50 absolute text-white   opacity-100  transition ease-linear  w-[80%] -bottom-[420px] rounded-2xl left-[50%] translate-x-[-50%]  from-[#f15b20] to-[#FF8F62]">

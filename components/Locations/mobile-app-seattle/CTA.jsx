...
const CTA = () => {
  return (
    <div className="w-[80%] relative  text-white bg-[url('/location/mobile-seattle/s-cta.png')] bg-cover bg-center hover:scale-105 transition-all ease-linear relative md:px-36 px-10 my-24 md:my-0 py-14 mx-auto rounded-[43px] overflow-hidden border border-[#DDDDDD]">
      <div className="flex items-center">
        <motion.img
          src="/location/mobile-seattle/cta-m1.png"
          alt="cta-mobile"
          className="-bottom-[75%] -left-28 absolute"
        ...
        <motion.img
          ...
          alt="cta-mobile"
          className="-bottom-[70%] -right-20 absolute"
          initial={{ y: 100, opacity: 0, rotate: 15 }}
          whileInView={{ y: 0, opacity: 1, rotate: 0 }}
          viewport={{ once: true }}
          transition={{ duration: 0.8 }}
        ...
        <div className="w-[60%] mx-auto justify-center h-[350px] flex flex-col items-center text-center">

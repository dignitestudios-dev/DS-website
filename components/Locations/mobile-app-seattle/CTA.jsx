...
const CTA = () => {
  return (
    <div className="w-[95%] lg:w-[80%] relative  text-white bg-[url('/location/mobile-seattle/s-cta.webp')] bg-cover bg-center hover:scale-105 transition ease-linear relative md:px-36 px-4 my-24 md:my-0 py-14 mx-auto rounded-[43px] overflow-hidden border border-[#DDDDDD]">

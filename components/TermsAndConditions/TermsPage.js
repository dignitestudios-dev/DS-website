    ...
    >
      ...
      <div>
        ...
        <p className="text-md font-medium">
          By accessing and placing an order with Dignite Studios, you confirm
          ...
          between you and Dignite Studios.
          <br />
          <br />
          Under no circumstances shall Dignite Studios team be liable for any
          ...
          Dignite Studios team or an authorized representative has been advised
          ...
          <br />
          <br />
          Dignite Studios will not be responsible for any outcome that may occur
        ...
        <p className="text-md font-medium">
          ...
          Studios (referred to in these Terms & Conditions as "Dignite Studios",
          "us", "we" or "our"), the provider of the Dignite Studios website and
          the services accessible from the Dignite Studios website (which are
          collectively referred to in these Terms & Conditions as the "Dignite
          Studios Service").
          <br />
          <br />
          You are agreeing to be bound by these Terms & Conditions. If you do
          not agree to these Terms & Conditions, please do not use the Dignite
          Studios Service. In these Terms & Conditions, "you" refers both to you
        ...
        <p className="text-md font-medium">
          ...
          <ul className="ml-4 list-disc">
            ...
            <li>
              ...
              it refers to Dignite Studios , (3505 Lake Lynda Dr #200, Orlando,
              FL 32817, United States), that is responsible for your information
              under this Terms & Conditions.
            </li>
            <li>
              Country: where Dignite Studios or the owners/founders of Dignite
              Studios are based, in this case is United States of America
            </li>
            <li>
        ...
        <p className="text-md font-medium">
          ...
          (collectively, "Suggestions") provided by you to Dignite Studios with
          respect to the website shall remain the sole and exclusive property of
          Dignite Studios.
          <br />
          <br />
          Dignite Studios shall be free to use, copy, modify, publish, or
        ...
        <p className="text-md font-medium">
          You acknowledge and agree that Dignite Studios may stop (permanently
          or temporarily) providing the Service (or any features within the
          Service) to you or to users generally at Dignite Studios’s sole
          discretion, without prior notice to you. You may stop using the
          Service at any time. You do not need to specifically inform Dignite
          Studios when you stop using the Service. You acknowledge and agree
          that if Dignite Studios disables access to your account, you may be
          prevented from accessing the Service, your account details or any
          files or other materials which is contained in your account. If we
          decide to change our Terms & Conditions, we will post those changes on
          this page, and/or update the Terms & Conditions modification date
          below.
        </p>

        <h3 className="text-xl font-bold mt-5">
          <span>Modifications to Our website</span>
        </h3>
        <p className="text-md font-medium">
          Dignite Studios reserves the right to modify, suspend or discontinue,
        ...
        <h3 className="text-xl font-bold mt-5">
          <span>Updates to Our website</span>
        </h3>
        <p className="text-md font-medium">
          Dignite Studios may from time to time provide enhancements or
          ...
          of the website. You agree that Dignite Studios has no obligation to{" "}
          <br />
          (i) provide any Updates, or <br /> (ii) continue to provide or enable
          any particular features and/or functionalities of the website to you.{" "}
          <br />
          You further agree that all Updates will be <br />
          (i) deemed to constitute an integral part of the website, and <br />
        ...
        <p className="text-md font-medium">
          ...
          ("Third- Party Services"). You acknowledge and agree that Dignite
          ...
          thereof. Dignite Studios does not assume and shall not have any
        ...
        <p className="text-md font-medium">
          ...
          Dignite Studios. Dignite Studios may, in its sole discretion, at any
          ...
          immediately, without prior notice from Dignite Studios, in the event
          that you fail to comply with any provision of this Agreement. You may
          also terminate this Agreement by deleting the website and all copies
          thereof from your computer. Upon termination of this Agreement, you
          shall cease all use of the website and delete all copies of the
          website from your computer. Termination of this Agreement will not
          limit any of Dignite Studios's rights or remedies at law or in equity
        ...
        <p className="text-md font-medium">
          You agree to indemnify and hold Dignite Studios and its parents,
        ...
        <p className="text-md font-medium">
          ...
          permitted under applicable law, Dignite Studios, on its own behalf and
          ...
          trade practice. Without limitation to the foregoing, Dignite Studios
          ...
          <br />
          <br />
          Without limiting the foregoing, neither Dignite Studios nor any
          Dignite Studios's provider makes any representation or warranty of any
          ...
          of Dignite Studios are free of viruses, scripts, trojan horses, worms,
        ...
        <p className="text-md font-medium">
          ...
          of Dignite Studios and any of its suppliers under any provision of
          ...
          Dignite Studios or its suppliers be liable for any special,
          ...
          provision of this Agreement), even if Dignite Studios or any supplier
          has been advised of the possibility of such damages and even if the
          remedy fails of its essential purpose. Some states/jurisdictions do
        ...
        <p className="text-md font-medium">
          ...
          any other legal notices published by Dignite Studios on the Services,
          shall constitute the entire agreement between you and Dignite Studios
          ...
          waiver of such term or any other term, and Dignite Studios’s failure
          to assert any right or provision under this Agreement shall not
          constitute a waiver of such right or provision. YOU AND Dignite
          Studios AGREE THAT ANY CAUSE OF ACTION ARISING OUT OF OR RELATED TO
        ...
        <p className="text-md font-medium">
          Dignite Studios reserves the right, at its sole discretion, to modify
          ...
          sole discretion. By continuing to access or use our website after any
          revisions become effective, you agree to be bound by the revised
          terms. If you do not agree to the new terms, you are no longer
          authorized to use Dignite Studios.
        </p>
        ...
        <p className="text-md font-medium">
          The Agreement constitutes the entire agreement between you and Dignite
          Studios regarding your use of the website and supersedes all prior and
          contemporaneous written or oral agreements between you and Dignite
          Studios. You may be subject to additional terms and conditions that
          apply when you use or purchase other Dignite Studios's services, which
          Dignite Studios will provide to you at the time of such use or
          purchase.
        </p>

        <h3 className="text-xl font-bold mt-5">
          <span> Updates to Our Terms</span>
        </h3>
        <p className="text-md font-medium">
        ...
        <p className="text-md font-medium">
          ...
          arrangement thereof), are owned by Dignite Studios, its licensors or
          other providers of such material and are protected by United States of
          America and international copyright, trademark, patent, trade secret
          ...
          written permission of Dignite Studios, unless and except as is
        ...
        <p className="text-md font-medium">
          ...
          REGARDING THE ENFORCEMENT OR VALIDITY OF YOUR OR Dignite Studios’s
          INTELLECTUAL PROPERTY RIGHTS. The term “dispute” means any dispute,
          action, or other controversy between you and Dignite Studios
        ...
        <h3 className="text-xl font-bold mt-5">
          <span> Notice of Dispute</span>
        </h3>
        <p className="text-md font-medium">
          In the event of a dispute, you or Dignite Studios must give the other
          ...
          send any Notice of Dispute via email to: info@dignitestudios.com.
          Dignite Studios will send any Notice of Dispute to you by mail to your
          address if we have it, or otherwise to your email address. You and
          Dignite Studios will attempt to resolve any dispute through informal
          negotiation within sixty (60) days from the date the Notice of Dispute
          is sent. After sixty (60) days, you or Dignite Studios may commence
          arbitration.
        </p>
        ...
        <p className="text-md font-medium">
          If you and Dignite Studios don’t resolve any dispute by informal
        ...
        <h3 className="text-xl font-bold mt-5">
          <span> Submissions and Privacy</span>
        </h3>
        <p className="text-md font-medium">
          ...
          and will become the sole property of Dignite Studios without any
          compensation or credit to you whatsoever. Dignite Studios and its
        ...
        <p className="text-md font-medium">
          Dignite Studios may, from time to time, include contests, promotions,
        ...
        <p className="text-md font-medium">
          ...
          representative of Dignite Studios. Dignite Studios will be entitled to
          ...
          breach by you. Dignite Studios operates and controls the Dignite
          Studios Service from its offices in United States of America. The
          ...
          choose to access the Dignite Studios Service from other locations do
          ...
          Terms & Conditions (which include and incorporate the Dignite Studios
          Privacy Policy) contains the entire understanding, and supersedes all
          prior understandings, between you and Dignite Studios concerning its
        ...
        <p>
          ...
          <ul className="ml-4 list-disc">
            <li>
              Via Email:{" "}
              <a href="mailto:info@dignitestudios.com">
            ...
            <li>
              Via this Link:{" "}
              <a href="https://www.dignitestudios.com/">
                https://www.dignitestudios.com/
              </a>
            </li>
            <li>Via this Address: 3505 LakeLynda Dr, Suite 200</li>
          </ul>
        </p>
      </div>
    </div>

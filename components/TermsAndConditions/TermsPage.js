    ...
    return (
        <div className='w-full h-auto flex flex-col gap-4 justify-start items-start px-4 md:px-12 lg:px-64 lg:pb-10' style={{
            ...
            <div>
                ...
                <p>
                    <ul className='ml-4 list-disc'>
                        ...
                        <li>
                            ...
                            Dignite Studios or its affiliates, partners, suppliers or the licensors of the website
                ...
                <h3 className='text-xl font-bold mt-5'><span >Your Suggestions</span></h3>
                <p className='text-md font-medium'>

                    Any feedback, comments, ideas, improvements or suggestions (collectively, "Suggestions") provided by you
                    to Dignite Studios with respect to the website shall remain the sole and exclusive property of Dignite Studios.<br />
                    <br />
                    Dignite Studios shall be free to use, copy, modify, publish, or redistribute the Suggestions for any purpose
                    and in any way without any credit or any compensation to you.


                </p>
                <h3 className='text-xl font-bold mt-5'><span >Your Consent</span></h3>
                <p className='text-md font-medium'>
                ...
                <h3 className='text-xl font-bold mt-5'><span >Links to Other Websites</span></h3>
                <p className='text-md font-medium'>


                    This Terms & Conditions applies only to the Services. The Services may contain links to other websites not
                    operated or controlled by Dignite Studios. We are not responsible for the content, accuracy or opinions
                ...
                <h3 className='text-xl font-bold mt-5'><span >Cookies</span></h3>
                <p className='text-md font-medium'>



                    Dignite Studios uses "Cookies" to identify the areas of our website that you have visited. A Cookie is a small
                ...
                <h3 className='text-xl font-bold mt-5'><span >Changes To Our Terms & Conditions</span></h3>
                <p className='text-md font-medium'>




                    You acknowledge and agree that Dignite Studios may stop (permanently or temporarily) providing the
                    Service (or any features within the Service) to you or to users generally at Dignite Studios’s sole discretion,
                    without prior notice to you. You may stop using the Service at any time. You do not need to specifically
                    inform Dignite Studios when you stop using the Service. You acknowledge and agree that if Dignite Studios
                    disables access to your account, you may be prevented from accessing the Service, your account details or
                ...
                <h3 className='text-xl font-bold mt-5'><span >Modifications to Our website</span></h3>
                <p className='text-md font-medium'>




                    Dignite Studios reserves the right to modify, suspend or discontinue, temporarily or permanently, the website
                ...
                <h3 className='text-xl font-bold mt-5'><span >Updates to Our website</span></h3>
                <p className='text-md font-medium'>

                    Dignite Studios may from time to time provide enhancements or improvements to the features/ functionality

                    of the website, which may include patches, bug fixes, updates, upgrades and other modifications
                    ("Updates"). <br />
                    Updates may modify or delete certain features and/or functionalities of the website. You agree that Dignite
                    Studios has no obligation to <br />
                    (i) provide any Updates, or  <br /> (ii) continue to provide or enable any particular
                    features and/or functionalities of the website to you. <br />
                    You further agree that all Updates will be  <br />(i) deemed to constitute an integral part of the website, and  <br />(ii)
                ...
                <h3 className='text-xl font-bold mt-5'><span >Third-Party Services</span></h3>
                <p className='text-md font-medium'>
                    ...
                    You acknowledge and agree that Dignite Studios shall not be responsible for any Third-Party Services,
                    including their accuracy, completeness, timeliness, validity, copyright compliance, legality, decency, quality
                    or any other aspect thereof. Dignite Studios does not assume and shall not have any liability or responsibility
                ...
                <h3 className='text-xl font-bold mt-5'><span >Term and Termination</span></h3>
                <p className='text-md font-medium'>

                    This Agreement shall remain in effect until terminated by you or Dignite Studios.
                    Dignite Studios may, in its sole discretion, at any time and for any or no reason, suspend or terminate this
                    Agreement with or without prior notice.
                    This Agreement will terminate immediately, without prior notice from Dignite Studios, in the event that you fail
                    ...
                    Termination of this Agreement will not limit any of Dignite Studios's rights or remedies at law or in equity in
                    case of breach by you (during the term of this Agreement) of any of your obligations under the present
                    Agreement.

                </p>

                <h3 className='text-xl font-bold mt-5'><span >Copyright Infringement Notice</span></h3>
                <p className='text-md font-medium'>
                ...
                <h3 className='text-xl font-bold mt-5'><span >Indemnification</span></h3>
                <p className='text-md font-medium'>


                    You agree to indemnify and hold Dignite Studios and its parents, subsidiaries, affiliates, officers, employees,
                ...
                <h3 className='text-xl font-bold mt-5'><span >No Warranties</span></h3>
                <p className='text-md font-medium'>



                    The website is provided to you "AS IS" and "AS AVAILABLE" and with all faults and defects without warranty
                    of any kind. To the maximum extent permitted under applicable law, Dignite Studios, on its own behalf and
                    ...
                    foregoing, Dignite Studios provides no warranty or undertaking, and makes no representation of any kind
                    that the website will meet your requirements, achieve any intended results, be compatible or work with any
                    other software, websites, systems or services, operate without interruption, meet any performance or
                    reliability standards or be error free or that any errors or defects can or will be corrected.<br /><br />
                    Without limiting the foregoing, neither Dignite Studios nor any Dignite Studios's provider makes any
                    ...
                    behalf of Dignite Studios are free of viruses, scripts, trojan horses, worms, malware, timebombs or other
                ...
                <h3 className='text-xl font-bold mt-5'><span > Limitation of Liability</span></h3>
                <p className='text-md font-medium'>



                    Notwithstanding any damages that you might incur, the entire liability of Dignite Studios and any of its
                    ...
                    To the maximum extent permitted by applicable law, in no event shall Dignite Studios or its suppliers be
                    ...
                    this Agreement), even if Dignite Studios or any supplier has been advised of the possibility of such damages
                ...
                <h3 className='text-xl font-bold mt-5'><span > Severability</span></h3>
                <p className='text-md font-medium'>
                    ...
                    This Agreement, together with the Privacy Policy and any other legal notices published by Dignite Studios on
                    the Services, shall constitute the entire agreement between you and Dignite Studios concerning the
                    ...
                    continuing waiver of such term or any other term, and Dignite Studios’s failure to assert any right or provision
                    under this Agreement shall not constitute a waiver of such right or provision. YOU AND Dignite Studios
                ...
                <h3 className='text-xl font-bold mt-5'><span > Waiver</span></h3>
                <p className='text-md font-medium'>
                ...
                <h3 className='text-xl font-bold mt-5'><span > Amendments to this Agreement</span></h3>
                <p className='text-md font-medium'>

                    Dignite Studios reserves the right, at its sole discretion, to modify or replace this Agreement at any time. If a
                    ...
                    the revised terms. If you do not agree to the new terms, you are no longer authorized to use Dignite Studios.
                </p>

                <h3 className='text-xl font-bold mt-5'><span > Entire Agreement</span></h3>
                <p className='text-md font-medium'>

                    The Agreement constitutes the entire agreement between you and Dignite Studios regarding your use of the
                    website and supersedes all prior and contemporaneous written or oral agreements between you and Dignite
                    Studios.
                    You may be subject to additional terms and conditions that apply when you use or purchase other Dignite
                    Studios's services, which Dignite Studios will provide to you at the time of such use or purchase.
                </p>

                <h3 className='text-xl font-bold mt-5'><span >  Updates to Our Terms</span></h3>
                <p className='text-md font-medium'>
                ...
                <h3 className='text-xl font-bold mt-5'><span >  Intellectual Property</span></h3>
                <p className='text-md font-medium'>
                    ...
                    owned by Dignite Studios, its licensors or other providers of such material and are protected by United
                    States of America and international copyright, trademark, patent, trade secret and other intellectual property
                    or proprietary rights laws. The material may not be copied, modified, reproduced, downloaded or distributed
                    in any way, in whole or in part, without the express prior written permission of Dignite Studios, unless and
                    except as is expressly provided in these Terms & Conditions. Any unauthorized use of the material is
                    prohibited.
                </p>

                <h3 className='text-xl font-bold mt-5'><span >  Agreement to Arbitrate</span></h3>
                <p className='text-md font-medium'>

                    This section applies to any dispute EXCEPT IT DOESN’T INCLUDE A DISPUTE RELATING TO CLAIMS
                    FOR INJUNCTIVE OR EQUITABLE RELIEF REGARDING THE ENFORCEMENT OR VALIDITY OF YOUR
                    OR Dignite Studios’s INTELLECTUAL PROPERTY RIGHTS. The term “dispute” means any dispute, action,
                    or other controversy between you and Dignite Studios concerning the Services or this agreement, whether in
                ...
                <h3 className='text-xl font-bold mt-5'><span > Notice of Dispute</span></h3>
                <p className='text-md font-medium'>



                    In the event of a dispute, you or Dignite Studios must give the other a Notice of Dispute, which is a written
                    ...
                    info@dignitestudios.com. Dignite Studios will send any Notice of Dispute to you by mail to your address if we
                    have it, or otherwise to your email address. You and Dignite Studios will attempt to resolve any dispute
                    through informal negotiation within sixty (60) days from the date the Notice of Dispute is sent. After sixty (60)
                    days, you or Dignite Studios may commence arbitration.
                </p>

                <h3 className='text-xl font-bold mt-5'><span > Binding Arbitration</span></h3>
                <p className='text-md font-medium'>




                    If you and Dignite Studios don’t resolve any dispute by informal negotiation, any other effort to resolve the
                ...
                <h3 className='text-xl font-bold mt-5'><span >  Submissions and Privacy</span></h3>
                <p className='text-md font-medium'>
                    ...
                    non-confidential and non-proprietary and will become the sole property of Dignite Studios without any
                    compensation or credit to you whatsoever. Dignite Studios and its affiliates shall have no obligations with
                ...
                <h3 className='text-xl font-bold mt-5'><span >Promotions</span></h3>
                <p className='text-md font-medium'>




                    Dignite Studios may, from time to time, include contests, promotions, sweepstakes, or other activities
                ...
                <h3 className='text-xl font-bold mt-5'><span >Typographical Errors</span></h3>
                <p className='text-md font-medium'>
                ...
                <h3 className='text-xl font-bold mt-5'><span >Miscellaneous</span></h3>
                <p className='text-md font-medium'>
                    ...
                    authorized representative of Dignite Studios. Dignite Studios will be entitled to injunctive or other equitable
                    relief (without the obligations of posting any bond or surety) in the event of any breach or anticipatory breach
                    by you. Dignite Studios operates and controls the Dignite Studios Service from its offices in United States of
                    America. The Service is not intended for distribution to or use by any person or entity in any jurisdiction or
                    country where such distribution or use would be contrary to law or regulation. Accordingly, those persons
                    who choose to access the Dignite Studios Service from other locations do so on their own initiative and are
                    solely responsible for compliance with local laws, if and to the extent local laws are applicable. These Terms
                    & Conditions (which include and incorporate the Dignite Studios Privacy Policy) contains the entire
                    understanding, and supersedes all prior understandings, between you and Dignite Studios concerning its
                ...
                <h3 className='text-xl font-bold mt-5'><span >Contact Us</span></h3>
                ...
                <p>
                    ...
                    <ul className='ml-4 list-disc'>
                        ...
                        <li>
                            Via Email: <a href='mailto:info@dignitestudios.com'>info@dignitestudios.com</a>
                        </li>
                        <li>
                            Via Phone Number: <a href='tel:+1877710 770'>877 710 1770</a>
                        </li>
                        <li>
                            Via this Link: <a href='https://www.dignitestudios.com/'>https://www.dignitestudios.com/</a>
                        </li>
                        <li>
                            Via this Address: 3505 LakeLynda Dr, Suite 200
                        </li>

...
import MaidSimplTechnologyCard from "./MyMedicalJournalTechnologyCard";
import Link from "next/link";
import { HiArrowRight } from "react-icons/hi2";

const MyMedicalJournalTechnologies = () => {
  ...
  return (
    ...
    >
      ...
      <div className="w-auto flex justify-start items-center gap-2">
        <Link
          href="https://play.google.com/store/apps/details?id=com.dignitestudios.mymedicaljournal"
        ...
        <Link
          href="https://apps.apple.com/us/app/my-medical-journal-app/id6502008545"
          className={`mt-2 w-auto h-[60px] border-[1px]  rounded-full px-4 flex items-center justify-center gap-3 ${
            theme == "dark"
              ? "border-[1px] border-white text-white"
              : "border-[1px] border-black text-black"
...
export default MyMedicalJournalTechnologies;

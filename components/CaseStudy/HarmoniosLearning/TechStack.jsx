          ...
          {techIcons.map((tech, index) => (
            ...
            >
              <div className="relative">
                {/* Icon Container */}
                <div className="w-20 h-20 bg-white  rounded-2xl shadow-lg shadow-purple-600/20 flex items-center justify-center transition duration-300 group-hover:shadow-2xl">
                  <span className="text-4xl"><img src={tech.icon} alt="During the development of Harmonious Learning, we  - Tech"  /></span>
                </div>

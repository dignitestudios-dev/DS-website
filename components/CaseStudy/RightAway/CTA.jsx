...
const CTA = () => {
  return (
    <section className="-mt-12 lg:-mt-28 -mb-8 lg:-mb-16 relative w-full bg-[#151515] mb-20 px-4 flex flex-col items-center overflow-hidden">
      ...
      >
        ...
        <div className="relative z-10 w-full max-w-[788px] flex flex-col justify-end items-center gap-[30px] px-6 text-center">
          ...
          <h2 className="w-full text-white text-[32px] md:text-[44px] font-medium font-poppins leading-[120%]">
            Launch a Platform That Simplifies Every Order
          </h2>

          <p className="w-full max-w-[750px] text-white/90 font-poppins font-normal text-[14px] md:text-[15px] leading-[160%]">
            Create a scalable construction materials marketplace with custom applications, supplier portals, delivery management tools and a centralized admin system built to support efficient business operations and long term growth.
          </p>

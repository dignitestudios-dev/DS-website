  ...
  return (
    <section className="w-full py-16  relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto text-center px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 w-full md:w-[80%]  relative mx-auto ">
          <div className="absolute md:block hidden left-[50%] translate-x-[-50%] top-[26.5%] z-50" >
          <DiscoveryIcon/>
          </div>

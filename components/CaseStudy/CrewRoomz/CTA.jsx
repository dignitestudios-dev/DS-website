...
const CTA = () => {
  return (
    <div className="-mt-12 lg:-mt-28 -mb-8 lg:-mb-16 bg-gradient-to-b dark:from-[#22232400] dark:to:[#86C4F0] from-[#86C4F0] md:pb-0 pb-8 pt-8 to-[#F1F8FD] relative overflow-hidden">

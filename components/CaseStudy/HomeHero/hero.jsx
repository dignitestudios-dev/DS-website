      ...
      <div className="w-full gap-2 flex flex-col items-center ">
        ...
        <div className="flex flex-col items-center text-center w-[90%] md:w-[70%]">
          ...
          <div className="flex items-center gap-4">
            <Link href={"https://play.google.com/store/apps/details?id=com.dignitestudios.homeheroservice&pli=1"}  target="_blank" rel="noopener noreferrer" >
            <img
            ...
            <Link target="_blank" rel="noopener noreferrer"  href={"https://apps.apple.com/us/app/home-hero-provider/id6746242679"}>
            <img

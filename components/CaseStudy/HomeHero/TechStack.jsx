             ...
             {techIcons.map((tech, index) => (
               ...
               >
                 <div className="relative z-50">
                   {/* Icon Container */}
                   <div className="w-20 h-20 bg-white rounded-2xl shadow-xl shadow-[#64486D]/20 flex items-center justify-center transition duration-300 group-hover:shadow-[#64486D]/20 group-hover:shadow-xl">

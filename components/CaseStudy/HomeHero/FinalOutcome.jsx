...
<div  >
  <div className="flex justify-start max-w-screen-2xl mx-auto w-[80%]  mb-24 mt-36">
          {" "}
          <h2 className="bg-[#64486D] relative px-8 py-3 rounded-r-full  text-white flex items-center">
...
<div className="mt-16">
   <div className="flex justify-end max-w-screen-2xl mx-auto w-[80%] mt-36 mb-16">
          {" "}
          <h2 className="bg-[#64486D] relative px-8 py-3 rounded-l-full  text-white flex items-center">
            User Interface

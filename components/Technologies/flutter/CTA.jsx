...
const CTA = () => {
  return (
    <div className="w-[95%]  lg:w-[80%] 2xl:w-[65%] h-[500px] text-white lg:bg-transparent bg-black lg:bg-[url('/technologies/flutter/s-cta.webp')] bg-contain bg-no-repeat flex items-center justify-center bg-center  transition ease-linear relative md:px-14 px-10 my-24 md:my-0 py-14 mx-auto rounded-[43px] overflow-hidden ">

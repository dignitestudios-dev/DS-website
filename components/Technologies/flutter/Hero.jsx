    ...
    <div className="w-full grid grid-cols-1  justify-start items-start ">
      <div className="flex relative z-20  w-[90%] md:w-[70%] flex-col text-center mx-auto items-center">
        ...
        <p className="text-lg my-6 dark:text-white text-[#5C5C5C]">
          Dignite Studios is the reputable Flutter app development company which
          helps businesses and startups in the USA and California create mobile
          applications which are rapid, reliable and ready for expansion. We
          focus on the performance, usability and the long term scalability. Our
          Flutter experts design the products which load faster, scale smoothly
          and deliver consistent user express across various platforms.
        </p>

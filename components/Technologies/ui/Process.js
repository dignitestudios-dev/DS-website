...
const Process = ({header , header2 ,  button, para , steps}) => {
    ...
    >
      ...
      >
        ...
        >
          ...
          <h2
            className={`lg:font-bold text-center w-[80%] mx-auto capitalize font-bold md:text-7xl text-4xl tracking-tighter xl:font-bold`}
          >
            {header} {" "}{header2&& <span className="text-orange-600">{header2}</span>}
          </h2>
          <p

...
const techRoutes = {
  "Flutter": "/technologies/flutter-app-development",
  "React": "/technologies/react-native-app-development",
  "React Native": "/technologies/react-native-app-development",
  "Cross Platform": "/technologies/cross-platform-app-development",
  "AI Automation": "/technologies/ai-automation-services",
};

const TechStackCard = ({ tech, index }) => {
  const link = techRoutes[tech?.title] || tech?.link;
  ...
  return (
    <div className="w-full max-w-[189px]">
      {link ? (
        <Link href={link} className="w-full inline-block">
          {CardContent}
        </Link>
      ) : (
        CardContent

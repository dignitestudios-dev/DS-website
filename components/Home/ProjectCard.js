  ...
  return (
    <Link
      ...
      <img
        src={image}
        alt={title}
        className="w-full  rounded-xl md:rounded-3xl h-[110px] md:h-[220px] lg:h-[340px]  hover:brightness-80 transition-all duration-700"
      />
      ...
      <div className="flex flex-col justify-start my-1 items-start md:px-2">
        ...
        <p
          ...
          className="text-[9px] md:text-xs lg:text-sm font-normal "
        >
          {description}
        </p>
      </div>

...
const MobileAppServiceCard = () => {
  ...
  const paragraphFull = (
    <>
      ...
      <Link href="/services/mobile-app-development-services" className="text-orange-600">
  ...
  const paragraphFull5 = (
    <>
      ...
      <Link href="/services/mobile-app-design-services" className="text-orange-600">
  ...
  return (
    <div className="w-full grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 mt-6">
      ...
      >
        <img
          src="/top-mobile-app-development-services.png"
          alt=""
      ...
      >
        <img
          src="/home-android-app-development.png"
          alt=""
          className="w-full h-[200px] rounded-xl"
        />
        <div className="flex flex-col items-start text-start gap-1 pt-3">
      ...
      >
        <img
          src="/home-web-app-development.png"
          alt=""
          className="w-full h-[200px] rounded-xl"
        />
        <div className="flex flex-col items-start text-start gap-1 pt-3">
      ...
      >
        <img
          src="/top-mobile-app-design-services.png"
          alt=""
          className="w-full h-[200px] rounded-xl"
        />
        <div className="flex flex-col items-start text-start gap-1 pt-3">
      ...
      >
        <img
          src="/top-mobile-app-development-testing-services.png"
          alt=""
          className="w-full h-[200px] rounded-xl"
        />
        <div className="flex flex-col items-start text-start gap-1 pt-3">

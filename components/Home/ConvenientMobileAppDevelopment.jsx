...
const ConvenientMobileAppDevelopment = () => {
  ...
  return (
    <div
      className="global-padding-horizontal py-20 w-full text-center"
      id="services"
    >
      <h2 className="uppercase font-extrabold  lg:text-center text-4xl xl:text-[72px] 2xl:text-[104px] tracking-tighter lg:font-bold lg:text-[64px] lg:leading-[77.45px] 2xl:leading-[107px]">
      ...
      <p
        className={`text-sm text-center lg:text-[16px] my-3 lg:leading-[24.48px] font-[400] lg:w-full ${

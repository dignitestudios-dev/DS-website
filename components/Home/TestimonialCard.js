...
const TestimonialCard = ({ review }) => {
  ...
  return (
    <div
      className={`w-full h-72 min-h-72 md:min-h-80 md:h-80 lg:h-80 lg:min-h-80 xl:min-h-72 xl:h-72 relative  col-span-1 flex flex-col justify-center items-start gap-3`}
      style={{
        color: palette?.color,
      }}
    >
      ...
      <div className="w-auto h-[20%] absolute bottom-0 left-0 flex gap-2 justify-start items-center">
        <img src={review?.image} alt="" className="rounded-full w-14 h-14" width="56px" height="56px" />

...
export default function HomePage() {
    ...
    return (
        <div className='w-full h-auto flex flex-col items-center justify-start overflow-x-hidden overflow-y-auto'>
            ...
            <button name='scroll-to-top' onClick={scrollToTop} className='shadow-lg text-2xl flex justify-center items-center w-14 h-14 rounded-full  text-white fixed bottom-4 left-4' style={{

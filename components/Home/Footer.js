...
const Footer = () => {
  ...
  return (
    <div
      className={`w-full h-auto relative z-50 transition-all duration-300 flex flex-col gap-3 lg:gap-10 py-6 lg:py-12 justify-start items-start px-4 md:px-12 lg:px-28 xl:px-[120px] 2xl:px-48 `}
      style={{

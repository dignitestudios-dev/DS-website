...
export const metadata = {
  title: " Android App Development Services | Scalable Apps",
  description:
    " Get reliable android app development services to build secure, scalable, and high-performing mobile apps for startups and enterprises with Dignite Studios.",
  alternates: {

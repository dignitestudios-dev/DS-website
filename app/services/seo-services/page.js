import AppMarketingServices from "@/components/services/AppMarketingServices/AppMarketingServices";
import SEOMarketingServices from "@/components/services/SEOMarketingServices/SEOMarketingServices";
import GlobalLayout from "@/layout/GlobalLayout";
import Script from "next/script";
import React from "react";

export const metadata = {
  title: "SEO Services - Top Web Solutions USA",
  description:
    "Get SEO services and custom digital marketing services to improve your website's visibility and drive organic traffic.",
  alternates: {
    canonical: "https://www.dignitestudios.com/services/seo-services",
  },
};
...
const page = () => {
  return (
    <div>
      <GlobalLayout page={<SEOMarketingServices />} />
      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Service",
            name: "SEO Services",
            url: "https://www.dignitestudios.com/services/seo-services",
            description:
              "Get SEO services and custom digital marketing services to improve your website's visibility and drive organic traffic.",
            provider: {
              "@type": "Organization",

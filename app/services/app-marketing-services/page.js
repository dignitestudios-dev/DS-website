...
export const metadata = {
  title: "App Marketing Services - Top Web Solutions USA",
  description:
    "Get app design and development services and custom app development services to build scalable and conversion-focused app that drive business growth.",
  alternates: {
...
const page = () => {
  return (
    <div>
      <GlobalLayout page={<AppMarketingServices />} />
      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "Professional web design services including custom website design, responsive layouts, UI/UX design, and SEO-friendly websites for businesses and startups.",
            provider: {
              "@type": "Organization",

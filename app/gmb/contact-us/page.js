import PpcContactPage from "@/components/ContactUs/PpcContactPage";
...
export const metadata = {
  ...
  description:
    "Get a quick consultation over your project idea with Dignite's aspiring team.",
};
...
const page = () => {
  return (
    <>
      ...
      <div>
        <GlobalLayout page={<PpcContactPage />} />;
      </div>
    </>
  );
};

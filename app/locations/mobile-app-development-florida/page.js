import MobileAppFlorida from "@/components/Locations/mobile-app-florida/MobileAppFlorida";
// import MobileAppNewYork from "@/components/Locations/mobile-app-new-york/MobileAppNewYork";
import GlobalLayout from "@/layout/GlobalLayout";
import React from "react";

export const metadata = {
  title: "Mobile App Development Company in Florida | Dignite Studios",
  description:
    "Choose a trusted Mobile App Development Company in Florida for innovative, scalable solutions. Explore Mobile App Development In Florida today!",
  alternates: {
    canonical:
      "https://www.dignitestudios.com/locations/mobile-app-development-florida",
  },
};
...
const breadcrumbSchema = {
  ...
  "@type": "BreadcrumbList",
  "@id":
    "https://www.dignitestudios.com/locations/mobile-app-development-new-york/#breadcrumb",
  itemListElement: [
    {
      "@type": "ListItem",
      position: 1,
...
const faqSchema = {
  ...
  "@type": "FAQPage",
  "@id":
    "https://www.dignitestudios.com/locations/mobile-app-development-new-york/#faq",
  mainEntity: [
    {
      "@type": "Question",
...
const page = () => {
  return (
    <>
      ...
      /> */}
      <GlobalLayout page={<MobileAppFlorida />} />
    </>
  );
};
